...
func (x *ResourceVersion) GetResource() *Resource {
	if x != nil {
		return x.Resource
	}
	return nil
...
func (x *ResourceVersion) GetVersion() float64 {
	if x != nil {
		return x.Version
	}
	return 0
...
var file_meta_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x0d, 0x52, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x22, 0x68, 0x0a, 0x0f, 0x52, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x3b, 0x0a, 0x08,
	...
	0x79, 0x2e, 0x6d, 0x65, 0x74, 0x61, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52,
	0x08, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x76, 0x65, 0x72,
	0x73, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x01, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73,
...
var file_meta_proto_goTypes = []interface{}{
	...
	(*ResourceVersion)(nil), // 2: io.linkerd.proxy.meta.ResourceVersion
}
var file_meta_proto_depIdxs = []int32{
	1, // 0: io.linkerd.proxy.meta.Metadata.resource:type_name -> io.linkerd.proxy.meta.Resource
	1, // 1: io.linkerd.proxy.meta.ResourceVersion.resource:type_name -> io.linkerd.proxy.meta.Resource
