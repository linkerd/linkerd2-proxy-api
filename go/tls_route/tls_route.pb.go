...
import (
	_ "github.com/linkerd/linkerd2-proxy-api/go/http_types"
...
func (x *TlsRouteMatch) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TlsRouteMatch) ProtoMessage() {}

func (x *TlsRouteMatch) ProtoReflect() protoreflect.Message {
	mi := &file_tls_route_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TlsRouteMatch.ProtoReflect.Descriptor instead.
func (*TlsRouteMatch) Descriptor() ([]byte, []int) {
...
var file_tls_route_proto_rawDesc = []byte{
	...
	,
	...
	0x67, 0x6f, 0x2f, 0x74, 0x6c, 0x73, 0x5f, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_tls_route_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_tls_route_proto_goTypes = []interface{}{
	(*SniMatch)(nil),        // 0: io.linkerd.proxy.tls_route.SniMatch
	(*TlsRouteMatch)(nil),   // 1: io.linkerd.proxy.tls_route.TlsRouteMatch
	(*SniMatch_Suffix)(nil), // 2: io.linkerd.proxy.tls_route.SniMatch.Suffix
}
var file_tls_route_proto_depIdxs = []int32{
	2, // 0: io.linkerd.proxy.tls_route.SniMatch.suffix:type_name -> io.linkerd.proxy.tls_route.SniMatch.Suffix
...
func file_tls_route_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_tls_route_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_tls_route_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TlsRouteMatch); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_tls_route_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SniMatch_Suffix); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_tls_route_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*SniMatch_Exact)(nil),
