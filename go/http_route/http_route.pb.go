...
var file_http_route_proto_rawDesc = []byte{
	...
	0x65, 0x66, 0x69, 0x78, 0x42, 0x09, 0x0a, 0x07, 0x72, 0x65, 0x70, 0x6c, 0x61, 0x63, 0x65, 0x42,
...
var file_http_route_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_http_route_proto_goTypes = []interface{}{
	...
	(*HostMatch_Suffix)(nil),      // 8: io.linkerd.proxy.http_route.HostMatch.Suffix
	(*http_types.HttpMethod)(nil), // 9: io.linkerd.proxy.http_types.HttpMethod
	(*http_types.Headers)(nil),    // 10: io.linkerd.proxy.http_types.Headers
	(*http_types.Scheme)(nil),     // 11: io.linkerd.proxy.http_types.Scheme
}
var file_http_route_proto_depIdxs = []int32{
	8,  // 0: io.linkerd.proxy.http_route.HostMatch.suffix:type_name -> io.linkerd.proxy.http_route.HostMatch.Suffix
	...
	9,  // 4: io.linkerd.proxy.http_route.RouteMatch.method:type_name -> io.linkerd.proxy.http_types.HttpMethod
	10, // 5: io.linkerd.proxy.http_route.RequestHeaderModifier.add:type_name -> io.linkerd.proxy.http_types.Headers
	10, // 6: io.linkerd.proxy.http_route.RequestHeaderModifier.set:type_name -> io.linkerd.proxy.http_types.Headers
	11, // 7: io.linkerd.proxy.http_route.RequestRedirect.scheme:type_name -> io.linkerd.proxy.http_types.Scheme
