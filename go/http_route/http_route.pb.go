...
func (x *ErrorResponder) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ErrorResponder) ProtoMessage() {}

func (x *ErrorResponder) ProtoReflect() protoreflect.Message {
	mi := &file_http_route_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ErrorResponder.ProtoReflect.Descriptor instead.
func (*ErrorResponder) Descriptor() ([]byte, []int) {
	return file_http_route_proto_rawDescGZIP(), []int{8}
}

func (x *ErrorResponder) GetStatus() uint32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *ErrorResponder) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_http_route_proto_rawDesc = []byte{
	...
	0x42, 0x0a, 0x0e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x64, 0x65,
	...
	0x61, 0x67, 0x65, 0x42, 0x35, 0x5a, 0x33, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	...
	0x68, 0x74, 0x74, 0x70, 0x5f, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_http_route_proto_goTypes = []interface{}{
	...
	(*ErrorResponder)(nil),        // 8: io.linkerd.proxy.http_route.ErrorResponder
