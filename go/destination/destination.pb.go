...
func (*GetDestination) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_b0f2e0a5ad2ee78a, []int{0}
}
...
func (*Update) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_b0f2e0a5ad2ee78a, []int{1}
}
...
func (*AddrSet) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_b0f2e0a5ad2ee78a, []int{2}
}
...
func (*WeightedAddrSet) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_b0f2e0a5ad2ee78a, []int{3}
}
...
func (*WeightedAddr) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_b0f2e0a5ad2ee78a, []int{4}
}
...
func (*TlsIdentity) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_b0f2e0a5ad2ee78a, []int{5}
}
...
func (*TlsIdentity_DnsLikeIdentity) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_b0f2e0a5ad2ee78a, []int{5, 0}
}
...
func (*NoEndpoints) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_b0f2e0a5ad2ee78a, []int{6}
}
...
func (*ProtocolHint) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_b0f2e0a5ad2ee78a, []int{7}
}
...
func (*ProtocolHint_H2) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_b0f2e0a5ad2ee78a, []int{7, 0}
}
...
func (*DestinationProfile) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_b0f2e0a5ad2ee78a, []int{8}
}
...
func (*Route) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_b0f2e0a5ad2ee78a, []int{9}
}
...
func (*RetryBudget) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_b0f2e0a5ad2ee78a, []int{10}
}
...
func (*ResponseClass) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_b0f2e0a5ad2ee78a, []int{11}
}
...
func (*RequestMatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_b0f2e0a5ad2ee78a, []int{12}
}
...
func (*RequestMatch_Seq) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_b0f2e0a5ad2ee78a, []int{12, 0}
}
...
func (*PathMatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_b0f2e0a5ad2ee78a, []int{13}
}
...
func (*ResponseMatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_b0f2e0a5ad2ee78a, []int{14}
}
...
func (*ResponseMatch_Seq) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_b0f2e0a5ad2ee78a, []int{14, 0}
}
...
func (*HttpStatusRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_b0f2e0a5ad2ee78a, []int{15}
}
...
func (*WeightedDst) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_b0f2e0a5ad2ee78a, []int{16}
}
...
func init() { proto.RegisterFile("destination.proto", fileDescriptor_destination_b0f2e0a5ad2ee78a) }

var fileDescriptor_destination_b0f2e0a5ad2ee78a = []byte{
	// 1269 bytes of a gzipped FileDescriptorProto
	,
}
