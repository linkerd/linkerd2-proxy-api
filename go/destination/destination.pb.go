...
type HeaderMatch_OperationType int32

const (
	// The header must have exactly one value and it must satisfy the match.
	HeaderMatch_EQUALS HeaderMatch_OperationType = 0
	// The header must contain at least one value that satisfies the match.
	HeaderMatch_CONTAINS HeaderMatch_OperationType = 1
)

var HeaderMatch_OperationType_name = map[int32]string{
	0: "EQUALS",
	1: "CONTAINS",
}
var HeaderMatch_OperationType_value = map[string]int32{
	"EQUALS":   0,
	"CONTAINS": 1,
}

func (x HeaderMatch_OperationType) String() string {
	return proto.EnumName(HeaderMatch_OperationType_name, int32(x))
}
func (HeaderMatch_OperationType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_destination_9749f7a6278c676f, []int{12, 0}
}
...
func (*GetDestination) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_9749f7a6278c676f, []int{0}
}
...
func (*Update) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_9749f7a6278c676f, []int{1}
}
...
func (*AddrSet) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_9749f7a6278c676f, []int{2}
}
...
func (*WeightedAddrSet) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_9749f7a6278c676f, []int{3}
}
...
func (*WeightedAddr) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_9749f7a6278c676f, []int{4}
}
...
func (*TlsIdentity) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_9749f7a6278c676f, []int{5}
}
...
func (*TlsIdentity_K8SPodIdentity) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_9749f7a6278c676f, []int{5, 0}
}
...
func (*NoEndpoints) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_9749f7a6278c676f, []int{6}
}
...
func (*ProtocolHint) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_9749f7a6278c676f, []int{7}
}
...
func (*ProtocolHint_H2) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_9749f7a6278c676f, []int{7, 0}
}
...
func (*DestinationProfile) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_9749f7a6278c676f, []int{8}
}
...
func (*Route) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_9749f7a6278c676f, []int{9}
}
...
func (*RetryBudget) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_9749f7a6278c676f, []int{10}
}
...
func (*ResponseClass) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_9749f7a6278c676f, []int{11}
}
...
type HeaderMatch struct {
	...
	Operation  HeaderMatch_OperationType `protobuf:"varint,2,opt,name=operation,proto3,enum=io.linkerd.proxy.destination.HeaderMatch_OperationType" json:"operation,omitempty"`
	// Types that are valid to be assigned to Match:
	//	*HeaderMatch_Exists
	//	*HeaderMatch_StringEq
	//	*HeaderMatch_StringRegex
	//	*HeaderMatch_IntEq
	//	*HeaderMatch_IntGeq
	//	*HeaderMatch_IntLeq
...
func (*HeaderMatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_9749f7a6278c676f, []int{12}
}
...
func (m *HeaderMatch) GetHeaderName() string {
	if m != nil {
		return m.HeaderName
	}
	return ""
...
func (m *HeaderMatch) GetOperation() HeaderMatch_OperationType {
	if m != nil {
		return m.Operation
	}
	return HeaderMatch_EQUALS
}
...
type HeaderMatch_Exists struct {
	Exists bool `protobuf:"varint,3,opt,name=exists,proto3,oneof"`
}

type HeaderMatch_StringEq struct {
	StringEq string `protobuf:"bytes,4,opt,name=string_eq,json=stringEq,proto3,oneof"`
}

type HeaderMatch_StringRegex struct {
	StringRegex string `protobuf:"bytes,5,opt,name=string_regex,json=stringRegex,proto3,oneof"`
}

type HeaderMatch_IntEq struct {
	IntEq uint64 `protobuf:"varint,6,opt,name=int_eq,json=intEq,proto3,oneof"`
}

type HeaderMatch_IntGeq struct {
	IntGeq uint64 `protobuf:"varint,7,opt,name=int_geq,json=intGeq,proto3,oneof"`
}

type HeaderMatch_IntLeq struct {
	IntLeq uint64 `protobuf:"varint,8,opt,name=int_leq,json=intLeq,proto3,oneof"`
}

func (*HeaderMatch_Exists) isHeaderMatch_Match() {}

func (*HeaderMatch_StringEq) isHeaderMatch_Match() {}

func (*HeaderMatch_StringRegex) isHeaderMatch_Match() {}

func (*HeaderMatch_IntEq) isHeaderMatch_Match() {}

func (*HeaderMatch_IntGeq) isHeaderMatch_Match() {}

func (*HeaderMatch_IntLeq) isHeaderMatch_Match() {}
...
func (m *HeaderMatch) GetExists() bool {
	if x, ok := m.GetMatch().(*HeaderMatch_Exists); ok {
		return x.Exists
	}
	return false
}

func (m *HeaderMatch) GetStringEq() string {
	if x, ok := m.GetMatch().(*HeaderMatch_StringEq); ok {
		return x.StringEq
	}
	return ""
}

func (m *HeaderMatch) GetStringRegex() string {
	if x, ok := m.GetMatch().(*HeaderMatch_StringRegex); ok {
		return x.StringRegex
	}
	return ""
}

func (m *HeaderMatch) GetIntEq() uint64 {
	if x, ok := m.GetMatch().(*HeaderMatch_IntEq); ok {
		return x.IntEq
	}
	return 0
}

func (m *HeaderMatch) GetIntGeq() uint64 {
	if x, ok := m.GetMatch().(*HeaderMatch_IntGeq); ok {
		return x.IntGeq
	}
	return 0
}

func (m *HeaderMatch) GetIntLeq() uint64 {
	if x, ok := m.GetMatch().(*HeaderMatch_IntLeq); ok {
		return x.IntLeq
	}
	return 0
}
...
func (*HeaderMatch) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _HeaderMatch_OneofMarshaler, _HeaderMatch_OneofUnmarshaler, _HeaderMatch_OneofSizer, []interface{}{
		(*HeaderMatch_Exists)(nil),
		(*HeaderMatch_StringEq)(nil),
		(*HeaderMatch_StringRegex)(nil),
		(*HeaderMatch_IntEq)(nil),
		(*HeaderMatch_IntGeq)(nil),
		(*HeaderMatch_IntLeq)(nil),
	}
}
...
func _HeaderMatch_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *HeaderMatch_Exists:
		...
		b.EncodeVarint(t)
	case *HeaderMatch_StringEq:
		b.EncodeVarint(4<<3 | proto.WireBytes)
		b.EncodeStringBytes(x.StringEq)
	case *HeaderMatch_StringRegex:
		b.EncodeVarint(5<<3 | proto.WireBytes)
		b.EncodeStringBytes(x.StringRegex)
	case *HeaderMatch_IntEq:
		b.EncodeVarint(6<<3 | proto.WireVarint)
		b.EncodeVarint(uint64(x.IntEq))
	case *HeaderMatch_IntGeq:
		b.EncodeVarint(7<<3 | proto.WireVarint)
		b.EncodeVarint(uint64(x.IntGeq))
	case *HeaderMatch_IntLeq:
		b.EncodeVarint(8<<3 | proto.WireVarint)
		b.EncodeVarint(uint64(x.IntLeq))
	case nil:
	default:
		return fmt.Errorf("HeaderMatch.Match has unexpected type %T", x)
	}
	return nil
}
...
func _HeaderMatch_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 3: // match.exists
		...
		m.Match = &HeaderMatch_Exists{x != 0}
		return true, err
	case 4: // match.string_eq
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.Match = &HeaderMatch_StringEq{x}
		return true, err
	case 5: // match.string_regex
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.Match = &HeaderMatch_StringRegex{x}
		return true, err
	case 6: // match.int_eq
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		...
		x, err := b.DecodeVarint()
		m.Match = &HeaderMatch_IntEq{x}
		return true, err
	case 7: // match.int_geq
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.Match = &HeaderMatch_IntGeq{x}
		return true, err
	case 8: // match.int_leq
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.Match = &HeaderMatch_IntLeq{x}
		return true, err
	default:
		return false, nil
	}
...
func _HeaderMatch_OneofSizer(msg proto.Message) (n int) {
	...
	case *HeaderMatch_StringEq:
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(len(x.StringEq)))
		n += len(x.StringEq)
	case *HeaderMatch_StringRegex:
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(len(x.StringRegex)))
		n += len(x.StringRegex)
	case *HeaderMatch_IntEq:
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(x.IntEq))
	case *HeaderMatch_IntGeq:
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(x.IntGeq))
	case *HeaderMatch_IntLeq:
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(x.IntLeq))
	case nil:
	default:
		panic(fmt.Sprintf("proto: unexpected type %T in oneof", x))
	}
...
func (*RequestMatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_9749f7a6278c676f, []int{13}
}
...
type RequestMatch_Header struct {
	Header *HeaderMatch `protobuf:"bytes,6,opt,name=header,proto3,oneof"`
}
...
func (*RequestMatch_Header) isRequestMatch_Match() {}
...
func (m *RequestMatch) GetHeader() *HeaderMatch {
	if x, ok := m.GetMatch().(*RequestMatch_Header); ok {
		return x.Header
	}
	return nil
}
...
func _RequestMatch_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 6: // match.header
		...
		msg := new(HeaderMatch)
		err := b.DecodeMessage(msg)
		m.Match = &RequestMatch_Header{msg}
		return true, err
	default:
		return false, nil
	}
...
func (*RequestMatch_Seq) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_9749f7a6278c676f, []int{13, 0}
}
...
func (*PathMatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_9749f7a6278c676f, []int{14}
}
...
func (*ResponseMatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_9749f7a6278c676f, []int{15}
}
...
type ResponseMatch_Header struct {
	Header *HeaderMatch `protobuf:"bytes,5,opt,name=header,proto3,oneof"`
}
...
func (*ResponseMatch_Header) isResponseMatch_Match() {}
...
func (m *ResponseMatch) GetHeader() *HeaderMatch {
	if x, ok := m.GetMatch().(*ResponseMatch_Header); ok {
		return x.Header
	}
	return nil
}
...
func _ResponseMatch_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 5: // match.header
		...
		msg := new(HeaderMatch)
		err := b.DecodeMessage(msg)
		m.Match = &ResponseMatch_Header{msg}
		return true, err
	default:
		return false, nil
	}
...
func (*ResponseMatch_Seq) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_9749f7a6278c676f, []int{15, 0}
}
...
func (*HttpStatusRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_9749f7a6278c676f, []int{16}
}
...
func init() {
	...
	proto.RegisterType((*HeaderMatch)(nil), "io.linkerd.proxy.destination.HeaderMatch")
	...
	proto.RegisterEnum("io.linkerd.proxy.destination.HeaderMatch_OperationType", HeaderMatch_OperationType_name, HeaderMatch_OperationType_value)
}
...
func init() { proto.RegisterFile("destination.proto", fileDescriptor_destination_9749f7a6278c676f) }

var fileDescriptor_destination_9749f7a6278c676f = []byte{
	...
	,
}
