...
type WeightedAddr struct {
	...
	ConnectTimeout    *duration.Duration `protobuf:"bytes,8,opt,name=connect_timeout,json=connectTimeout,proto3" json:"connect_timeout,omitempty"`
...
func (x *WeightedAddr) GetConnectTimeout() *duration.Duration {
	if x != nil {
...
type DestinationProfile struct {
	...
	// as retries. Failed requests on retryable routes will not be retried if
	...
	//
	// Deprecated in favor of Strategy responses, which may include logical
	// splits.
	//
	// Deprecated: Do not use.
...
type StrategyRequest struct {
	...
	Target *net.TcpAddress `protobuf:"bytes,1,opt,name=target,proto3" json:"target,omitempty"`
	// An opaque value that is set at injection-time and sent with destintion
	// lookups.
	//
	// If, for instance, the token encodes a namespace or some locality
...
func (x *StrategyRequest) GetTarget() *net.TcpAddress {
	if x != nil {
		return x.Target
	}
	return nil
...
func (x *StrategyRequest) GetContextToken() string {
	if x != nil {
		return x.ContextToken
	}
	return ""
...
type StrategyResponse struct {
	...
	// Configures the protocol detection strategy to be used for the given
	// destination.
	Detect *ProtocolDetection `protobuf:"bytes,2,opt,name=detect,proto3" json:"detect,omitempty"`
	// Configures the proxying strategy to be used for the given destination.
	Logical *Logical `protobuf:"bytes,3,opt,name=logical,proto3" json:"logical,omitempty"`
}

func (x *StrategyResponse) Reset() {
	*x = StrategyResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_destination_proto_msgTypes[19]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StrategyResponse) Descriptor() ([]byte, []int) {
	return file_destination_proto_rawDescGZIP(), []int{19}
}

func (x *StrategyResponse) GetDetect() *ProtocolDetection {
	if x != nil {
		return x.Detect
	}
	return nil
...
func (x *StrategyResponse) GetLogical() *Logical {
	if x != nil {
		return x.Logical
	}
	return nil
...
type ProtocolDetection struct {
	...
	// Types that are assignable to Strategy:
	//	*ProtocolDetection_Client
	//	*ProtocolDetection_Opaque_
	Strategy isProtocolDetection_Strategy `protobuf_oneof:"strategy"`
}

func (x *ProtocolDetection) Reset() {
	*x = ProtocolDetection{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProtocolDetection) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProtocolDetection) ProtoMessage() {}

func (x *ProtocolDetection) ProtoReflect() protoreflect.Message {
	mi := &file_destination_proto_msgTypes[20]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProtocolDetection.ProtoReflect.Descriptor instead.
func (*ProtocolDetection) Descriptor() ([]byte, []int) {
	return file_destination_proto_rawDescGZIP(), []int{20}
}

func (m *ProtocolDetection) GetStrategy() isProtocolDetection_Strategy {
	if m != nil {
		return m.Strategy
	}
	return nil
...
func (x *ProtocolDetection) GetClient() *ProtocolDetection_ClientData {
	if x, ok := x.GetStrategy().(*ProtocolDetection_Client); ok {
		return x.Client
	}
	return nil
}

func (x *ProtocolDetection) GetOpaque() *ProtocolDetection_Opaque {
	if x, ok := x.GetStrategy().(*ProtocolDetection_Opaque_); ok {
		return x.Opaque
	}
	return nil
}

type isProtocolDetection_Strategy interface {
	isProtocolDetection_Strategy()
}

type ProtocolDetection_Client struct {
	Client *ProtocolDetection_ClientData `protobuf:"bytes,1,opt,name=client,proto3,oneof"`
}

type ProtocolDetection_Opaque_ struct {
	Opaque *ProtocolDetection_Opaque `protobuf:"bytes,2,opt,name=opaque,proto3,oneof"`
}

func (*ProtocolDetection_Client) isProtocolDetection_Strategy() {}

func (*ProtocolDetection_Opaque_) isProtocolDetection_Strategy() {}

// Indicates the endpoint is a logical service that is backed by one or more
// concrete services.
type Logical struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	...
	//	*Logical_Concrete
	//	*Logical_Split_
	Kind isLogical_Kind `protobuf_oneof:"kind"`
}
...
func (*Logical) Descriptor() ([]byte, []int) {
	return file_destination_proto_rawDescGZIP(), []int{21}
}

func (m *Logical) GetKind() isLogical_Kind {
	if m != nil {
		return m.Kind
	}
	return nil
...
func (x *Logical) GetConcrete() *Concrete {
	if x, ok := x.GetKind().(*Logical_Concrete); ok {
		return x.Concrete
	}
	return nil
}

func (x *Logical) GetSplit() *Logical_Split {
	if x, ok := x.GetKind().(*Logical_Split_); ok {
		return x.Split
	}
	return nil
}

type isLogical_Kind interface {
	isLogical_Kind()
}

type Logical_Concrete struct {
	Concrete *Concrete `protobuf:"bytes,1,opt,name=concrete,proto3,oneof"`
}

type Logical_Split_ struct {
	Split *Logical_Split `protobuf:"bytes,2,opt,name=split,proto3,oneof"`
}

func (*Logical_Concrete) isLogical_Kind() {}

func (*Logical_Split_) isLogical_Kind() {}
...
type Concrete struct {
	...
	//	*Concrete_Forward_
	//	*Concrete_Balance_
	Kind isConcrete_Kind `protobuf_oneof:"kind"`
}
...
func (*Concrete) Descriptor() ([]byte, []int) {
	return file_destination_proto_rawDescGZIP(), []int{22}
}

func (m *Concrete) GetKind() isConcrete_Kind {
	if m != nil {
		return m.Kind
	}
	return nil
...
func (x *Concrete) GetForward() *Concrete_Forward {
	if x, ok := x.GetKind().(*Concrete_Forward_); ok {
		return x.Forward
	}
	return nil
}

func (x *Concrete) GetBalance() *Concrete_Balance {
	if x, ok := x.GetKind().(*Concrete_Balance_); ok {
		return x.Balance
	}
	return nil
}

type isConcrete_Kind interface {
	isConcrete_Kind()
}

type Concrete_Forward_ struct {
	Forward *Concrete_Forward `protobuf:"bytes,1,opt,name=forward,proto3,oneof"`
}

type Concrete_Balance_ struct {
	Balance *Concrete_Balance `protobuf:"bytes,2,opt,name=balance,proto3,oneof"`
}

func (*Concrete_Forward_) isConcrete_Kind() {}

func (*Concrete_Balance_) isConcrete_Kind() {}
...
func (x *ResponseMatch_Seq) Reset() {
	*x = ResponseMatch_Seq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_destination_proto_msgTypes[29]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
// Configures the proxy to detect the protocol of the TCP stream by
// peeking/reading the client's stream.
type ProtocolDetection_ClientData struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	BufferCapacity uint32             `protobuf:"varint,1,opt,name=buffer_capacity,json=bufferCapacity,proto3" json:"buffer_capacity,omitempty"`
	Timeout        *duration.Duration `protobuf:"bytes,2,opt,name=timeout,proto3" json:"timeout,omitempty"`
}

func (x *ProtocolDetection_ClientData) Reset() {
	*x = ProtocolDetection_ClientData{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProtocolDetection_ClientData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProtocolDetection_ClientData) ProtoMessage() {}

func (x *ProtocolDetection_ClientData) ProtoReflect() protoreflect.Message {
	mi := &file_destination_proto_msgTypes[30]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProtocolDetection_ClientData.ProtoReflect.Descriptor instead.
func (*ProtocolDetection_ClientData) Descriptor() ([]byte, []int) {
	return file_destination_proto_rawDescGZIP(), []int{20, 0}
}

func (x *ProtocolDetection_ClientData) GetBufferCapacity() uint32 {
	if x != nil {
...
func (x *ProtocolDetection_ClientData) GetTimeout() *duration.Duration {
	if x != nil {
		return x.Timeout
	}
	return nil
...
// Configures the proxy to handle the given destination as an opaque TCP
// stream without performing protocol detection.
type ProtocolDetection_Opaque struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *ProtocolDetection_Opaque) Reset() {
	*x = ProtocolDetection_Opaque{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProtocolDetection_Opaque) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProtocolDetection_Opaque) ProtoMessage() {}

func (x *ProtocolDetection_Opaque) ProtoReflect() protoreflect.Message {
	mi := &file_destination_proto_msgTypes[31]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProtocolDetection_Opaque.ProtoReflect.Descriptor instead.
func (*ProtocolDetection_Opaque) Descriptor() ([]byte, []int) {
	return file_destination_proto_rawDescGZIP(), []int{20, 1}
}

// Distributes traffic over a weighted distribution of inner targets.
type Logical_Split struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Targets []*Logical_Split_Weighted `protobuf:"bytes,1,rep,name=targets,proto3" json:"targets,omitempty"`
}

func (x *Logical_Split) Reset() {
	*x = Logical_Split{}
	if protoimpl.UnsafeEnabled {
		mi := &file_destination_proto_msgTypes[32]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *Logical_Split) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Logical_Split) ProtoMessage() {}

func (x *Logical_Split) ProtoReflect() protoreflect.Message {
	mi := &file_destination_proto_msgTypes[32]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Logical_Split.ProtoReflect.Descriptor instead.
func (*Logical_Split) Descriptor() ([]byte, []int) {
	return file_destination_proto_rawDescGZIP(), []int{21, 0}
}

func (x *Logical_Split) GetTargets() []*Logical_Split_Weighted {
	if x != nil {
		return x.Targets
	}
	return nil
...
type Logical_Split_Weighted struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Target *Logical `protobuf:"bytes,1,opt,name=target,proto3" json:"target,omitempty"`
	// The proportion of requests to send to this destination.  This value is
	// relative to other weights in the same set of WeightedLogicals.
	Weight uint32 `protobuf:"varint,2,opt,name=weight,proto3" json:"weight,omitempty"`
}

func (x *Logical_Split_Weighted) Reset() {
	*x = Logical_Split_Weighted{}
	if protoimpl.UnsafeEnabled {
		mi := &file_destination_proto_msgTypes[33]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *Logical_Split_Weighted) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Logical_Split_Weighted) ProtoMessage() {}

func (x *Logical_Split_Weighted) ProtoReflect() protoreflect.Message {
	mi := &file_destination_proto_msgTypes[33]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Logical_Split_Weighted.ProtoReflect.Descriptor instead.
func (*Logical_Split_Weighted) Descriptor() ([]byte, []int) {
	return file_destination_proto_rawDescGZIP(), []int{21, 0, 0}
}

func (x *Logical_Split_Weighted) GetTarget() *Logical {
	if x != nil {
		return x.Target
	}
	return nil
...
func (x *Logical_Split_Weighted) GetWeight() uint32 {
	if x != nil {
		return x.Weight
	}
	return 0
...
// Configures the proxy to forward traffic to the specified endpoint.
type Concrete_Forward struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Addr *WeightedAddr `protobuf:"bytes,1,opt,name=addr,proto3" json:"addr,omitempty"`
}

func (x *Concrete_Forward) Reset() {
	*x = Concrete_Forward{}
	if protoimpl.UnsafeEnabled {
		mi := &file_destination_proto_msgTypes[34]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *Concrete_Forward) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Concrete_Forward) ProtoMessage() {}

func (x *Concrete_Forward) ProtoReflect() protoreflect.Message {
	mi := &file_destination_proto_msgTypes[34]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Concrete_Forward.ProtoReflect.Descriptor instead.
func (*Concrete_Forward) Descriptor() ([]byte, []int) {
	return file_destination_proto_rawDescGZIP(), []int{22, 0}
}

func (x *Concrete_Forward) GetAddr() *WeightedAddr {
	if x != nil {
		return x.Addr
	}
	return nil
...
// Indicates the endpoint is a concrete service that can be resolved via
// Destination.Get.
type Concrete_Balance struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// The logical service's name:port.
	Authority          string             `protobuf:"bytes,1,opt,name=authority,proto3" json:"authority,omitempty"`
	PeakEwmaDecay      *duration.Duration `protobuf:"bytes,2,opt,name=peak_ewma_decay,json=peakEwmaDecay,proto3" json:"peak_ewma_decay,omitempty"`
	PeakEwmaDefaultRtt *duration.Duration `protobuf:"bytes,3,opt,name=peak_ewma_default_rtt,json=peakEwmaDefaultRtt,proto3" json:"peak_ewma_default_rtt,omitempty"`
}

func (x *Concrete_Balance) Reset() {
	*x = Concrete_Balance{}
	if protoimpl.UnsafeEnabled {
		mi := &file_destination_proto_msgTypes[35]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *Concrete_Balance) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Concrete_Balance) ProtoMessage() {}

func (x *Concrete_Balance) ProtoReflect() protoreflect.Message {
	mi := &file_destination_proto_msgTypes[35]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Concrete_Balance.ProtoReflect.Descriptor instead.
func (*Concrete_Balance) Descriptor() ([]byte, []int) {
	return file_destination_proto_rawDescGZIP(), []int{22, 1}
}

func (x *Concrete_Balance) GetAuthority() string {
	if x != nil {
		return x.Authority
	}
	return ""
...
func (x *Concrete_Balance) GetPeakEwmaDecay() *duration.Duration {
	if x != nil {
		return x.PeakEwmaDecay
	}
	return nil
}

func (x *Concrete_Balance) GetPeakEwmaDefaultRtt() *duration.Duration {
	if x != nil {
		return x.PeakEwmaDefaultRtt
	}
	return nil
}
...
var file_destination_proto_rawDesc = []byte{
	...
	0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xc7, 0x04, 0x0a, 0x0c, 0x57,
	...
	0x72, 0x12, 0x4c, 0x0a, 0x0c, 0x74, 0x6c, 0x73, 0x5f, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74,
	0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x29, 0x2e, 0x69, 0x6f, 0x2e, 0x6c, 0x69, 0x6e,
	...
	,
	...
	0x6c, 0x48, 0x69, 0x6e, 0x74, 0x52, 0x0c, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x48,
	0x69, 0x6e, 0x74, 0x12, 0x5e, 0x0a, 0x12, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x74, 0x79,
	...
	0x78, 0x79, 0x2e, 0x64, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x41,
	0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x4f, 0x76, 0x65, 0x72, 0x72, 0x69, 0x64, 0x65,
	0x52, 0x11, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x74, 0x79, 0x4f, 0x76, 0x65, 0x72, 0x72,
	0x69, 0x64, 0x65, 0x12, 0x42, 0x0a, 0x0f, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x5f, 0x74,
	...
	,
	...
	,
	...
	0x78, 0x79, 0x2e, 0x64, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x57,
	0x65, 0x69, 0x67, 0x68, 0x74, 0x65, 0x64, 0x44, 0x73, 0x74, 0x42, 0x02, 0x18, 0x01, 0x52, 0x0c,
	0x64, 0x73, 0x74, 0x4f, 0x76, 0x65, 0x72, 0x72, 0x69, 0x64, 0x65, 0x73, 0x22, 0xa2, 0x03, 0x0a,
	0x05, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x12, 0x48, 0x0a, 0x09, 0x63, 0x6f, 0x6e, 0x64, 0x69, 0x74,
	0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x69, 0x6f, 0x2e, 0x6c,
	0x69, 0x6e, 0x6b, 0x65, 0x72, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x2e, 0x64, 0x65, 0x73,
	...
	0x12, 0x56, 0x0a, 0x10, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x5f, 0x63, 0x6c, 0x61,
	0x73, 0x73, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x69, 0x6f, 0x2e,
	0x6c, 0x69, 0x6e, 0x6b, 0x65, 0x72, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x2e, 0x64, 0x65,
	0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x43, 0x6c, 0x61, 0x73, 0x73, 0x52, 0x0f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x43, 0x6c, 0x61, 0x73, 0x73, 0x65, 0x73, 0x12, 0x5d, 0x0a, 0x0e, 0x6d, 0x65, 0x74, 0x72,
	...
	0x6f, 0x78, 0x79, 0x2e, 0x64, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e,
	0x52, 0x6f, 0x75, 0x74, 0x65, 0x2e, 0x4d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x4c, 0x61, 0x62,
	0x65, 0x6c, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x0d, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63,
	0x73, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x73, 0x12, 0x21, 0x0a, 0x0c, 0x69, 0x73, 0x5f, 0x72, 0x65,
	0x74, 0x72, 0x79, 0x61, 0x62, 0x6c, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x69,
	0x73, 0x52, 0x65, 0x74, 0x72, 0x79, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x33, 0x0a, 0x07, 0x74, 0x69,
	...
	0x01, 0x22, 0x90, 0x01, 0x0a, 0x0b, 0x52, 0x65, 0x74, 0x72, 0x79, 0x42, 0x75, 0x64, 0x67, 0x65,
	...
	0x03, 0x74, 0x74, 0x6c, 0x22, 0x79, 0x0a, 0x0d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x43, 0x6c, 0x61, 0x73, 0x73, 0x12, 0x49, 0x0a, 0x09, 0x63, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69,
	0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x69, 0x6f, 0x2e, 0x6c, 0x69,
	...
	,
	...
	0x71, 0x48, 0x00, 0x52, 0x03, 0x61, 0x6e, 0x79, 0x12, 0x3e, 0x0a, 0x03, 0x6e, 0x6f, 0x74, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2a, 0x2e, 0x69, 0x6f, 0x2e, 0x6c, 0x69, 0x6e, 0x6b, 0x65,
	...
	,
	...
	0x70, 0x72, 0x6f, 0x78, 0x79, 0x2e, 0x64, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x2e,
	0x53, 0x65, 0x71, 0x48, 0x00, 0x52, 0x03, 0x61, 0x6c, 0x6c, 0x12, 0x43, 0x0a, 0x03, 0x61, 0x6e,
	0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x69, 0x6f, 0x2e, 0x6c, 0x69, 0x6e,
	0x6b, 0x65, 0x72, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x2e, 0x64, 0x65, 0x73, 0x74, 0x69,
	...
	0x3f, 0x0a, 0x03, 0x6e, 0x6f, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x69,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x48, 0x00, 0x52, 0x03, 0x6e, 0x6f, 0x74,
	...
	0x6f, 0x78, 0x79, 0x2e, 0x64, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e,
	0x48, 0x74, 0x74, 0x70, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x48,
	0x00, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x1a, 0x4c, 0x0a, 0x03, 0x53, 0x65, 0x71,
	...
	0x72, 0x6f, 0x78, 0x79, 0x2e, 0x64, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x52, 0x07,
	0x6d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x73, 0x42, 0x07, 0x0a, 0x05, 0x6d, 0x61, 0x74, 0x63, 0x68,
	0x22, 0x35, 0x0a, 0x0f, 0x48, 0x74, 0x74, 0x70, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x61,
	...
	0x28, 0x0d, 0x52, 0x03, 0x6d, 0x61, 0x78, 0x22, 0x43, 0x0a, 0x0b, 0x57, 0x65, 0x69, 0x67, 0x68,
	0x74, 0x65, 0x64, 0x44, 0x73, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72,
	...
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0x70, 0x0a, 0x0f,
	...
	0x78, 0x79, 0x2e, 0x6e, 0x65, 0x74, 0x2e, 0x54, 0x63, 0x70, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73,
	0x73, 0x52, 0x06, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x12, 0x23, 0x0a, 0x0d, 0x63, 0x6f, 0x6e,
	0x74, 0x65, 0x78, 0x74, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0c, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x9c,
	0x01, 0x0a, 0x10, 0x53, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x47, 0x0a, 0x06, 0x64, 0x65, 0x74, 0x65, 0x63, 0x74, 0x18, 0x02, 0x20,
	...
	,
	...
	,
	...
	0x79, 0x2d, 0x61, 0x70, 0x69, 0x2f, 0x67, 0x6f, 0x2f, 0x64, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61,
...
var file_destination_proto_msgTypes = make([]protoimpl.MessageInfo, 36)
var file_destination_proto_goTypes = []interface{}{
	...
	(*StrategyRequest)(nil),              // 18: io.linkerd.proxy.destination.StrategyRequest
	(*StrategyResponse)(nil),             // 19: io.linkerd.proxy.destination.StrategyResponse
	(*ProtocolDetection)(nil),            // 20: io.linkerd.proxy.destination.ProtocolDetection
	(*Logical)(nil),                      // 21: io.linkerd.proxy.destination.Logical
	(*Concrete)(nil),                     // 22: io.linkerd.proxy.destination.Concrete
	nil,                                  // 23: io.linkerd.proxy.destination.WeightedAddrSet.MetricLabelsEntry
	nil,                                  // 24: io.linkerd.proxy.destination.WeightedAddr.MetricLabelsEntry
	(*TlsIdentity_DnsLikeIdentity)(nil),  // 25: io.linkerd.proxy.destination.TlsIdentity.DnsLikeIdentity
	(*ProtocolHint_H2)(nil),              // 26: io.linkerd.proxy.destination.ProtocolHint.H2
	nil,                                  // 27: io.linkerd.proxy.destination.Route.MetricsLabelsEntry
	(*RequestMatch_Seq)(nil),             // 28: io.linkerd.proxy.destination.RequestMatch.Seq
	(*ResponseMatch_Seq)(nil),            // 29: io.linkerd.proxy.destination.ResponseMatch.Seq
	(*ProtocolDetection_ClientData)(nil), // 30: io.linkerd.proxy.destination.ProtocolDetection.ClientData
	(*ProtocolDetection_Opaque)(nil),     // 31: io.linkerd.proxy.destination.ProtocolDetection.Opaque
	(*Logical_Split)(nil),                // 32: io.linkerd.proxy.destination.Logical.Split
	(*Logical_Split_Weighted)(nil),       // 33: io.linkerd.proxy.destination.Logical.Split.Weighted
	(*Concrete_Forward)(nil),             // 34: io.linkerd.proxy.destination.Concrete.Forward
	(*Concrete_Balance)(nil),             // 35: io.linkerd.proxy.destination.Concrete.Balance
	(*net.TcpAddress)(nil),               // 36: io.linkerd.proxy.net.TcpAddress
	(*duration.Duration)(nil),            // 37: google.protobuf.Duration
	(*http_types.HttpMethod)(nil),        // 38: io.linkerd.proxy.http_types.HttpMethod
}
var file_destination_proto_depIdxs = []int32{
	...
	36, // 3: io.linkerd.proxy.destination.AddrSet.addrs:type_name -> io.linkerd.proxy.net.TcpAddress
	4,  // 4: io.linkerd.proxy.destination.WeightedAddrSet.addrs:type_name -> io.linkerd.proxy.destination.WeightedAddr
	23, // 5: io.linkerd.proxy.destination.WeightedAddrSet.metric_labels:type_name -> io.linkerd.proxy.destination.WeightedAddrSet.MetricLabelsEntry
	36, // 6: io.linkerd.proxy.destination.WeightedAddr.addr:type_name -> io.linkerd.proxy.net.TcpAddress
	5,  // 7: io.linkerd.proxy.destination.WeightedAddr.tls_identity:type_name -> io.linkerd.proxy.destination.TlsIdentity
	24, // 8: io.linkerd.proxy.destination.WeightedAddr.metric_labels:type_name -> io.linkerd.proxy.destination.WeightedAddr.MetricLabelsEntry
	...
	37, // 11: io.linkerd.proxy.destination.WeightedAddr.connect_timeout:type_name -> google.protobuf.Duration
	25, // 12: io.linkerd.proxy.destination.TlsIdentity.dns_like_identity:type_name -> io.linkerd.proxy.destination.TlsIdentity.DnsLikeIdentity
	26, // 13: io.linkerd.proxy.destination.ProtocolHint.h2:type_name -> io.linkerd.proxy.destination.ProtocolHint.H2
	...
	17, // 16: io.linkerd.proxy.destination.DestinationProfile.dst_overrides:type_name -> io.linkerd.proxy.destination.WeightedDst
	13, // 17: io.linkerd.proxy.destination.Route.condition:type_name -> io.linkerd.proxy.destination.RequestMatch
	12, // 18: io.linkerd.proxy.destination.Route.response_classes:type_name -> io.linkerd.proxy.destination.ResponseClass
	27, // 19: io.linkerd.proxy.destination.Route.metrics_labels:type_name -> io.linkerd.proxy.destination.Route.MetricsLabelsEntry
	37, // 20: io.linkerd.proxy.destination.Route.timeout:type_name -> google.protobuf.Duration
	37, // 21: io.linkerd.proxy.destination.RetryBudget.ttl:type_name -> google.protobuf.Duration
	15, // 22: io.linkerd.proxy.destination.ResponseClass.condition:type_name -> io.linkerd.proxy.destination.ResponseMatch
	28, // 23: io.linkerd.proxy.destination.RequestMatch.all:type_name -> io.linkerd.proxy.destination.RequestMatch.Seq
	28, // 24: io.linkerd.proxy.destination.RequestMatch.any:type_name -> io.linkerd.proxy.destination.RequestMatch.Seq
	13, // 25: io.linkerd.proxy.destination.RequestMatch.not:type_name -> io.linkerd.proxy.destination.RequestMatch
	14, // 26: io.linkerd.proxy.destination.RequestMatch.path:type_name -> io.linkerd.proxy.destination.PathMatch
	38, // 27: io.linkerd.proxy.destination.RequestMatch.method:type_name -> io.linkerd.proxy.http_types.HttpMethod
	29, // 28: io.linkerd.proxy.destination.ResponseMatch.all:type_name -> io.linkerd.proxy.destination.ResponseMatch.Seq
	29, // 29: io.linkerd.proxy.destination.ResponseMatch.any:type_name -> io.linkerd.proxy.destination.ResponseMatch.Seq
	15, // 30: io.linkerd.proxy.destination.ResponseMatch.not:type_name -> io.linkerd.proxy.destination.ResponseMatch
	16, // 31: io.linkerd.proxy.destination.ResponseMatch.status:type_name -> io.linkerd.proxy.destination.HttpStatusRange
	36, // 32: io.linkerd.proxy.destination.StrategyRequest.target:type_name -> io.linkerd.proxy.net.TcpAddress
	20, // 33: io.linkerd.proxy.destination.StrategyResponse.detect:type_name -> io.linkerd.proxy.destination.ProtocolDetection
	21, // 34: io.linkerd.proxy.destination.StrategyResponse.logical:type_name -> io.linkerd.proxy.destination.Logical
	30, // 35: io.linkerd.proxy.destination.ProtocolDetection.client:type_name -> io.linkerd.proxy.destination.ProtocolDetection.ClientData
	31, // 36: io.linkerd.proxy.destination.ProtocolDetection.opaque:type_name -> io.linkerd.proxy.destination.ProtocolDetection.Opaque
	22, // 37: io.linkerd.proxy.destination.Logical.concrete:type_name -> io.linkerd.proxy.destination.Concrete
	32, // 38: io.linkerd.proxy.destination.Logical.split:type_name -> io.linkerd.proxy.destination.Logical.Split
	34, // 39: io.linkerd.proxy.destination.Concrete.forward:type_name -> io.linkerd.proxy.destination.Concrete.Forward
	35, // 40: io.linkerd.proxy.destination.Concrete.balance:type_name -> io.linkerd.proxy.destination.Concrete.Balance
	13, // 41: io.linkerd.proxy.destination.RequestMatch.Seq.matches:type_name -> io.linkerd.proxy.destination.RequestMatch
	15, // 42: io.linkerd.proxy.destination.ResponseMatch.Seq.matches:type_name -> io.linkerd.proxy.destination.ResponseMatch
	37, // 43: io.linkerd.proxy.destination.ProtocolDetection.ClientData.timeout:type_name -> google.protobuf.Duration
	33, // 44: io.linkerd.proxy.destination.Logical.Split.targets:type_name -> io.linkerd.proxy.destination.Logical.Split.Weighted
	21, // 45: io.linkerd.proxy.destination.Logical.Split.Weighted.target:type_name -> io.linkerd.proxy.destination.Logical
	4,  // 46: io.linkerd.proxy.destination.Concrete.Forward.addr:type_name -> io.linkerd.proxy.destination.WeightedAddr
	37, // 47: io.linkerd.proxy.destination.Concrete.Balance.peak_ewma_decay:type_name -> google.protobuf.Duration
	37, // 48: io.linkerd.proxy.destination.Concrete.Balance.peak_ewma_default_rtt:type_name -> google.protobuf.Duration
	0,  // 49: io.linkerd.proxy.destination.Destination.Get:input_type -> io.linkerd.proxy.destination.GetDestination
	0,  // 50: io.linkerd.proxy.destination.Destination.GetProfile:input_type -> io.linkerd.proxy.destination.GetDestination
	18, // 51: io.linkerd.proxy.destination.Destination.Strategy:input_type -> io.linkerd.proxy.destination.StrategyRequest
	1,  // 52: io.linkerd.proxy.destination.Destination.Get:output_type -> io.linkerd.proxy.destination.Update
	9,  // 53: io.linkerd.proxy.destination.Destination.GetProfile:output_type -> io.linkerd.proxy.destination.DestinationProfile
	19, // 54: io.linkerd.proxy.destination.Destination.Strategy:output_type -> io.linkerd.proxy.destination.StrategyResponse
...
func file_destination_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_destination_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
		...
		file_destination_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProtocolDetection); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_destination_proto_msgTypes[29].Exporter = func(v interface{}, i int) interface{} {
		...
		file_destination_proto_msgTypes[30].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProtocolDetection_ClientData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_destination_proto_msgTypes[31].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProtocolDetection_Opaque); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_destination_proto_msgTypes[32].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Logical_Split); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_destination_proto_msgTypes[33].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Logical_Split_Weighted); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_destination_proto_msgTypes[34].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Concrete_Forward); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_destination_proto_msgTypes[35].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Concrete_Balance); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_destination_proto_msgTypes[20].OneofWrappers = []interface{}{
		(*ProtocolDetection_Client)(nil),
		(*ProtocolDetection_Opaque_)(nil),
	}
	file_destination_proto_msgTypes[21].OneofWrappers = []interface{}{
		(*Logical_Concrete)(nil),
		(*Logical_Split_)(nil),
	}
	file_destination_proto_msgTypes[22].OneofWrappers = []interface{}{
		(*Concrete_Forward_)(nil),
		(*Concrete_Balance_)(nil),
	}
	type x struct{}
...
type DestinationClient interface {
	...
	Strategy(ctx context.Context, in *StrategyRequest, opts ...grpc.CallOption) (Destination_StrategyClient, error)
}
...
func (c *destinationClient) Strategy(ctx context.Context, in *StrategyRequest, opts ...grpc.CallOption) (Destination_StrategyClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Destination_serviceDesc.Streams[2], "/io.linkerd.proxy.destination.Destination/Strategy", opts...)
	if err != nil {
		return nil, err
	}
	x := &destinationStrategyClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Destination_StrategyClient interface {
	Recv() (*StrategyResponse, error)
	grpc.ClientStream
}

type destinationStrategyClient struct {
	grpc.ClientStream
}

func (x *destinationStrategyClient) Recv() (*StrategyResponse, error) {
	m := new(StrategyResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type DestinationServer interface {
	...
	Strategy(*StrategyRequest, Destination_StrategyServer) error
}
...
func (*UnimplementedDestinationServer) Strategy(*StrategyRequest, Destination_StrategyServer) error {
	return status.Errorf(codes.Unimplemented, "method Strategy not implemented")
}
...
func _Destination_Strategy_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(StrategyRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(DestinationServer).Strategy(m, &destinationStrategyServer{stream})
}

type Destination_StrategyServer interface {
	Send(*StrategyResponse) error
	grpc.ServerStream
}

type destinationStrategyServer struct {
	grpc.ServerStream
}

func (x *destinationStrategyServer) Send(m *StrategyResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
var _Destination_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "Strategy",
			Handler:       _Destination_Strategy_Handler,
			ServerStreams: true,
		},
	},
