...
var file_destination_proto_goTypes = []interface{}{
	...
	(*ProtocolHint_OpaqueTransport)(nil), // 22: io.linkerd.proxy.destination.ProtocolHint.OpaqueTransport
...
var file_destination_proto_depIdxs = []int32{
	...
	22, // 13: io.linkerd.proxy.destination.ProtocolHint.opaque_transport:type_name -> io.linkerd.proxy.destination.ProtocolHint.OpaqueTransport
