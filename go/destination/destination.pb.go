...
type DestinationProfile struct {
	...
	//
	// Only applies when the `proxy` is Logical.
	...
	Proxy *ProxyStrategy `protobuf:"bytes,4,opt,name=proxy,proto3" json:"proxy,omitempty"`
	// Configures the protocol detection strategy to be used for the given
	// destination.
	Detect *ProtocolDetection `protobuf:"bytes,5,opt,name=detect,proto3" json:"detect,omitempty"`
}
...
func (x *DestinationProfile) GetProxy() *ProxyStrategy {
	if x != nil {
		return x.Proxy
	}
	return nil
...
func (x *DestinationProfile) GetDetect() *ProtocolDetection {
	if x != nil {
		return x.Detect
	}
	return nil
...
type ProxyStrategy struct {
	...
	//	*ProxyStrategy_Endpoint_
	//	*ProxyStrategy_Logical_
	Kind isProxyStrategy_Kind `protobuf_oneof:"kind"`
}

func (x *ProxyStrategy) Reset() {
	*x = ProxyStrategy{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProxyStrategy) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProxyStrategy) ProtoMessage() {}

func (x *ProxyStrategy) ProtoReflect() protoreflect.Message {
	mi := &file_destination_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProxyStrategy.ProtoReflect.Descriptor instead.
func (*ProxyStrategy) Descriptor() ([]byte, []int) {
	return file_destination_proto_rawDescGZIP(), []int{10}
}

func (m *ProxyStrategy) GetKind() isProxyStrategy_Kind {
	if m != nil {
		return m.Kind
	}
	return nil
...
func (x *ProxyStrategy) GetEndpoint() *ProxyStrategy_Endpoint {
	if x, ok := x.GetKind().(*ProxyStrategy_Endpoint_); ok {
		return x.Endpoint
	}
	return nil
}

func (x *ProxyStrategy) GetLogical() *ProxyStrategy_Logical {
	if x, ok := x.GetKind().(*ProxyStrategy_Logical_); ok {
		return x.Logical
	}
	return nil
}

type isProxyStrategy_Kind interface {
	isProxyStrategy_Kind()
}

type ProxyStrategy_Endpoint_ struct {
	Endpoint *ProxyStrategy_Endpoint `protobuf:"bytes,1,opt,name=endpoint,proto3,oneof"`
}

type ProxyStrategy_Logical_ struct {
	Logical *ProxyStrategy_Logical `protobuf:"bytes,2,opt,name=logical,proto3,oneof"`
}

func (*ProxyStrategy_Endpoint_) isProxyStrategy_Kind() {}

func (*ProxyStrategy_Logical_) isProxyStrategy_Kind() {}
...
type ProxyStrategy_Endpoint struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ProxyStrategy_Endpoint) Reset() {
	*x = ProxyStrategy_Endpoint{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProxyStrategy_Endpoint) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProxyStrategy_Endpoint) ProtoMessage() {}

func (x *ProxyStrategy_Endpoint) ProtoReflect() protoreflect.Message {
	mi := &file_destination_proto_msgTypes[24]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProxyStrategy_Endpoint.ProtoReflect.Descriptor instead.
func (*ProxyStrategy_Endpoint) Descriptor() ([]byte, []int) {
	return file_destination_proto_rawDescGZIP(), []int{10, 0}
}

func (x *ProxyStrategy_Endpoint) GetAddr() *WeightedAddr {
	if x != nil {
		return x.Addr
	}
	return nil
...
// Indicates the endpoint is logical and can be resolved via Destination.Get.
//
// `WeightedDst` overrides may take precedence over this behavior.
type ProxyStrategy_Logical struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ProxyStrategy_Logical) Reset() {
	*x = ProxyStrategy_Logical{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProxyStrategy_Logical) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProxyStrategy_Logical) ProtoMessage() {}

func (x *ProxyStrategy_Logical) ProtoReflect() protoreflect.Message {
	mi := &file_destination_proto_msgTypes[25]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProxyStrategy_Logical.ProtoReflect.Descriptor instead.
func (*ProxyStrategy_Logical) Descriptor() ([]byte, []int) {
	return file_destination_proto_rawDescGZIP(), []int{10, 1}
}

func (x *ProxyStrategy_Logical) GetAuthority() string {
	if x != nil {
		return x.Authority
	}
	return ""
...
func (x *ProxyStrategy_Logical) GetMetricLabels() map[string]string {
	if x != nil {
		return x.MetricLabels
	}
	return nil
...
func (*ProtocolDetection_Opaque) Descriptor() ([]byte, []int) {
	return file_destination_proto_rawDescGZIP(), []int{11, 0}
}
...
func (*ProtocolDetection_Client) Descriptor() ([]byte, []int) {
	return file_destination_proto_rawDescGZIP(), []int{11, 1}
}
...
func (*ResponseMatch_Seq) Descriptor() ([]byte, []int) {
	return file_destination_proto_rawDescGZIP(), []int{17, 0}
}
...
var file_destination_proto_rawDesc = []byte{
	...
	0x48, 0x32, 0x42, 0x0a, 0x0a, 0x08, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x22, 0xfb,
	0x02, 0x0a, 0x12, 0x44, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72,
	...
	0x12, 0x41, 0x0a, 0x05, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x72, 0x6f, 0x78, 0x79, 0x53, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x52, 0x05, 0x70, 0x72,
	0x6f, 0x78, 0x79, 0x12, 0x47, 0x0a, 0x06, 0x64, 0x65, 0x74, 0x65, 0x63, 0x74, 0x18, 0x05, 0x20,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x06, 0x64, 0x65, 0x74, 0x65, 0x63, 0x74, 0x22, 0xdf, 0x03, 0x0a,
	0x0d, 0x50, 0x72, 0x6f, 0x78, 0x79, 0x53, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x12, 0x52,
	...
	,
	...
	,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x06, 0x0a, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x22, 0xd7,
	0x01, 0x0a, 0x11, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x44, 0x65, 0x74, 0x65, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x50, 0x0a, 0x06, 0x6f, 0x70, 0x61, 0x71, 0x75, 0x65, 0x18, 0x01,
	...
	0x69, 0x6f, 0x6e, 0x2e, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x44, 0x65, 0x74, 0x65,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x4f, 0x70, 0x61, 0x71, 0x75, 0x65, 0x48, 0x00, 0x52, 0x06,
	0x6f, 0x70, 0x61, 0x71, 0x75, 0x65, 0x12, 0x50, 0x0a, 0x06, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74,
	...
	0x52, 0x06, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x1a, 0x08, 0x0a, 0x06, 0x4f, 0x70, 0x61, 0x71,
	0x75, 0x65, 0x1a, 0x08, 0x0a, 0x06, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x42, 0x0a, 0x0a, 0x08,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x22, 0xa2, 0x03, 0x0a, 0x05, 0x52, 0x6f, 0x75,
	0x74, 0x65, 0x12, 0x48, 0x0a, 0x09, 0x63, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x18,
	...
	,
	...
	0x65, 0x6c, 0x73, 0x12, 0x21, 0x0a, 0x0c, 0x69, 0x73, 0x5f, 0x72, 0x65, 0x74, 0x72, 0x79, 0x61,
	0x62, 0x6c, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x69, 0x73, 0x52, 0x65, 0x74,
	0x72, 0x79, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x33, 0x0a, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75,
	0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x44, 0x75, 0x72, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x52, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x1a, 0x40, 0x0a, 0x12, 0x4d,
	...
	,
	...
	0x12, 0x42, 0x0a, 0x03, 0x61, 0x6e, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2e, 0x2e,
	0x69, 0x6f, 0x2e, 0x6c, 0x69, 0x6e, 0x6b, 0x65, 0x72, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x78, 0x79,
	...
	,
	...
	0x73, 0x2e, 0x48, 0x74, 0x74, 0x70, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x48, 0x00, 0x52, 0x06,
	0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x1a, 0x4b, 0x0a, 0x03, 0x53, 0x65, 0x71, 0x12, 0x44, 0x0a,
	0x07, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2a,
	...
	,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x52, 0x07, 0x6d, 0x61, 0x74, 0x63,
	0x68, 0x65, 0x73, 0x42, 0x07, 0x0a, 0x05, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x22, 0x35, 0x0a, 0x0f,
	0x48, 0x74, 0x74, 0x70, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x12,
	...
	0x6d, 0x61, 0x78, 0x22, 0x43, 0x0a, 0x0b, 0x57, 0x65, 0x69, 0x67, 0x68, 0x74, 0x65, 0x64, 0x44,
	...
	0x52, 0x06, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x32, 0xde, 0x01, 0x0a, 0x0b, 0x44, 0x65, 0x73,
	0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x5d, 0x0a, 0x03, 0x47, 0x65, 0x74, 0x12,
	...
	,
	...
	0x70, 0x69, 0x2f, 0x67, 0x6f, 0x2f, 0x64, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f,
...
var file_destination_proto_goTypes = []interface{}{
	...
	(*ProxyStrategy)(nil),               // 10: io.linkerd.proxy.destination.ProxyStrategy
	(*ProtocolDetection)(nil),           // 11: io.linkerd.proxy.destination.ProtocolDetection
	...
	(*ProxyStrategy_Endpoint)(nil),      // 24: io.linkerd.proxy.destination.ProxyStrategy.Endpoint
	(*ProxyStrategy_Logical)(nil),       // 25: io.linkerd.proxy.destination.ProxyStrategy.Logical
	nil,                                 // 26: io.linkerd.proxy.destination.ProxyStrategy.Logical.MetricLabelsEntry
	(*ProtocolDetection_Opaque)(nil),    // 27: io.linkerd.proxy.destination.ProtocolDetection.Opaque
	(*ProtocolDetection_Client)(nil),    // 28: io.linkerd.proxy.destination.ProtocolDetection.Client
...
var file_destination_proto_depIdxs = []int32{
	...
	22, // 11: io.linkerd.proxy.destination.TlsIdentity.dns_like_identity:type_name -> io.linkerd.proxy.destination.TlsIdentity.DnsLikeIdentity
	23, // 12: io.linkerd.proxy.destination.ProtocolHint.h2:type_name -> io.linkerd.proxy.destination.ProtocolHint.H2
	12, // 13: io.linkerd.proxy.destination.DestinationProfile.routes:type_name -> io.linkerd.proxy.destination.Route
	13, // 14: io.linkerd.proxy.destination.DestinationProfile.retry_budget:type_name -> io.linkerd.proxy.destination.RetryBudget
	19, // 15: io.linkerd.proxy.destination.DestinationProfile.dst_overrides:type_name -> io.linkerd.proxy.destination.WeightedDst
	10, // 16: io.linkerd.proxy.destination.DestinationProfile.proxy:type_name -> io.linkerd.proxy.destination.ProxyStrategy
	11, // 17: io.linkerd.proxy.destination.DestinationProfile.detect:type_name -> io.linkerd.proxy.destination.ProtocolDetection
	24, // 18: io.linkerd.proxy.destination.ProxyStrategy.endpoint:type_name -> io.linkerd.proxy.destination.ProxyStrategy.Endpoint
	25, // 19: io.linkerd.proxy.destination.ProxyStrategy.logical:type_name -> io.linkerd.proxy.destination.ProxyStrategy.Logical
	27, // 20: io.linkerd.proxy.destination.ProtocolDetection.opaque:type_name -> io.linkerd.proxy.destination.ProtocolDetection.Opaque
	28, // 21: io.linkerd.proxy.destination.ProtocolDetection.client:type_name -> io.linkerd.proxy.destination.ProtocolDetection.Client
	15, // 22: io.linkerd.proxy.destination.Route.condition:type_name -> io.linkerd.proxy.destination.RequestMatch
	14, // 23: io.linkerd.proxy.destination.Route.response_classes:type_name -> io.linkerd.proxy.destination.ResponseClass
	29, // 24: io.linkerd.proxy.destination.Route.metrics_labels:type_name -> io.linkerd.proxy.destination.Route.MetricsLabelsEntry
	33, // 25: io.linkerd.proxy.destination.Route.timeout:type_name -> google.protobuf.Duration
	33, // 26: io.linkerd.proxy.destination.RetryBudget.ttl:type_name -> google.protobuf.Duration
	17, // 27: io.linkerd.proxy.destination.ResponseClass.condition:type_name -> io.linkerd.proxy.destination.ResponseMatch
	30, // 28: io.linkerd.proxy.destination.RequestMatch.all:type_name -> io.linkerd.proxy.destination.RequestMatch.Seq
	30, // 29: io.linkerd.proxy.destination.RequestMatch.any:type_name -> io.linkerd.proxy.destination.RequestMatch.Seq
	15, // 30: io.linkerd.proxy.destination.RequestMatch.not:type_name -> io.linkerd.proxy.destination.RequestMatch
	16, // 31: io.linkerd.proxy.destination.RequestMatch.path:type_name -> io.linkerd.proxy.destination.PathMatch
	34, // 32: io.linkerd.proxy.destination.RequestMatch.method:type_name -> io.linkerd.proxy.http_types.HttpMethod
	31, // 33: io.linkerd.proxy.destination.ResponseMatch.all:type_name -> io.linkerd.proxy.destination.ResponseMatch.Seq
	31, // 34: io.linkerd.proxy.destination.ResponseMatch.any:type_name -> io.linkerd.proxy.destination.ResponseMatch.Seq
	17, // 35: io.linkerd.proxy.destination.ResponseMatch.not:type_name -> io.linkerd.proxy.destination.ResponseMatch
	18, // 36: io.linkerd.proxy.destination.ResponseMatch.status:type_name -> io.linkerd.proxy.destination.HttpStatusRange
	4,  // 37: io.linkerd.proxy.destination.ProxyStrategy.Endpoint.addr:type_name -> io.linkerd.proxy.destination.WeightedAddr
	26, // 38: io.linkerd.proxy.destination.ProxyStrategy.Logical.metric_labels:type_name -> io.linkerd.proxy.destination.ProxyStrategy.Logical.MetricLabelsEntry
	15, // 39: io.linkerd.proxy.destination.RequestMatch.Seq.matches:type_name -> io.linkerd.proxy.destination.RequestMatch
	17, // 40: io.linkerd.proxy.destination.ResponseMatch.Seq.matches:type_name -> io.linkerd.proxy.destination.ResponseMatch
	0,  // 41: io.linkerd.proxy.destination.Destination.Get:input_type -> io.linkerd.proxy.destination.GetDestination
	0,  // 42: io.linkerd.proxy.destination.Destination.GetProfile:input_type -> io.linkerd.proxy.destination.GetDestination
	1,  // 43: io.linkerd.proxy.destination.Destination.Get:output_type -> io.linkerd.proxy.destination.Update
	9,  // 44: io.linkerd.proxy.destination.Destination.GetProfile:output_type -> io.linkerd.proxy.destination.DestinationProfile
...
func file_destination_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_destination_proto_msgTypes[24].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProxyStrategy_Endpoint); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_destination_proto_msgTypes[25].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProxyStrategy_Logical); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_destination_proto_msgTypes[10].OneofWrappers = []interface{}{
		(*ProxyStrategy_Endpoint_)(nil),
		(*ProxyStrategy_Logical_)(nil),
	}
	file_destination_proto_msgTypes[11].OneofWrappers = []interface{}{
	...
	file_destination_proto_msgTypes[17].OneofWrappers = []interface{}{
