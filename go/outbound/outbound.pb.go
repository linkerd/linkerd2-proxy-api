...
func (x *FailureAccrual) GetUnified() *FailureAccrual_Unified {
	if x != nil {
...
type FailureAccrual_Unified_ struct {
	Unified *FailureAccrual_Unified `protobuf:"bytes,2,opt,name=unified,proto3,oneof"`
}

func (*FailureAccrual_ConsecutiveFailures_) isFailureAccrual_Kind() {}

func (*FailureAccrual_Unified_) isFailureAccrual_Kind() {}
...
type ExponentialBackoff struct {
	...
	RespectRetryAfterHint bool `protobuf:"varint,4,opt,name=respect_retry_after_hint,json=respectRetryAfterHint,proto3" json:"respect_retry_after_hint,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *ExponentialBackoff) GetRespectRetryAfterHint() bool {
	if x != nil {
		return x.RespectRetryAfterHint
	}
	return false
}
...
func (x *Backend_BalanceP2C) GetPenaltyPeakEwma() *Backend_BalanceP2C_PenaltyPeakEwma {
	if x != nil {
...
type Backend_BalanceP2C_PenaltyPeakEwma_ struct {
	// A variant of peak EWMA that injects artificial penalties based on response
	// codes, enabling 429-aware load balancing.
	PenaltyPeakEwma *Backend_BalanceP2C_PenaltyPeakEwma `protobuf:"bytes,3,opt,name=penalty_peak_ewma,json=penaltyPeakEwma,proto3,oneof"`
}

func (*Backend_BalanceP2C_PeakEwma_) isBackend_BalanceP2C_Load() {}

func (*Backend_BalanceP2C_PenaltyPeakEwma_) isBackend_BalanceP2C_Load() {}
...
type Backend_BalanceP2C_PenaltyPeakEwma struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Initial latency value used when no latencies have been
	// recorded for an endpoint.
	DefaultRtt *duration.Duration `protobuf:"bytes,1,opt,name=default_rtt,json=defaultRtt,proto3" json:"default_rtt,omitempty"`
	...
	Penalty *duration.Duration `protobuf:"bytes,3,opt,name=penalty,proto3" json:"penalty,omitempty"`
	// If true, the proxy will use the Retry-After hint (if present on the response)
	// as the penalty duration, clamped by the configured max_retry_after.
	RespectRetryAfterHint *Backend_BalanceP2C_PenaltyPeakEwma_RetryAfter `protobuf:"bytes,4,opt,name=respect_retry_after_hint,json=respectRetryAfterHint,proto3" json:"respect_retry_after_hint,omitempty"`
	// The EWMA decay window for the penalty.
	PenaltyDecay *duration.Duration `protobuf:"bytes,5,opt,name=penalty_decay,json=penaltyDecay,proto3" json:"penalty_decay,omitempty"`
	// HTTP status code ranges that should trigger load biasing penalties.
	HttpStatusRanges []*Backend_BalanceP2C_PenaltyPeakEwma_StatusRange `protobuf:"bytes,6,rep,name=http_status_ranges,json=httpStatusRanges,proto3" json:"http_status_ranges,omitempty"`
	// gRPC status codes that should trigger load biasing penalties.
	GrpcStatusCodes []uint32 `protobuf:"varint,7,rep,packed,name=grpc_status_codes,json=grpcStatusCodes,proto3" json:"grpc_status_codes,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}

func (x *Backend_BalanceP2C_PenaltyPeakEwma) Reset() {
	*x = Backend_BalanceP2C_PenaltyPeakEwma{}
	mi := &file_outbound_proto_msgTypes[59]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Backend_BalanceP2C_PenaltyPeakEwma) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Backend_BalanceP2C_PenaltyPeakEwma) ProtoMessage() {}

func (x *Backend_BalanceP2C_PenaltyPeakEwma) ProtoReflect() protoreflect.Message {
	mi := &file_outbound_proto_msgTypes[59]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Backend_BalanceP2C_PenaltyPeakEwma.ProtoReflect.Descriptor instead.
func (*Backend_BalanceP2C_PenaltyPeakEwma) Descriptor() ([]byte, []int) {
	return file_outbound_proto_rawDescGZIP(), []int{7, 1, 1}
}

func (x *Backend_BalanceP2C_PenaltyPeakEwma) GetDefaultRtt() *duration.Duration {
	if x != nil {
		return x.DefaultRtt
	}
	return nil
...
func (x *Backend_BalanceP2C_PenaltyPeakEwma) GetDecay() *duration.Duration {
	if x != nil {
		return x.Decay
	}
	return nil
...
func (x *Backend_BalanceP2C_PenaltyPeakEwma) GetPenalty() *duration.Duration {
	if x != nil {
		return x.Penalty
	}
	return nil
...
func (x *Backend_BalanceP2C_PenaltyPeakEwma) GetRespectRetryAfterHint() *Backend_BalanceP2C_PenaltyPeakEwma_RetryAfter {
	if x != nil {
		return x.RespectRetryAfterHint
	}
	return nil
...
func (x *Backend_BalanceP2C_PenaltyPeakEwma) GetPenaltyDecay() *duration.Duration {
	if x != nil {
...
func (x *Backend_BalanceP2C_PenaltyPeakEwma) GetHttpStatusRanges() []*Backend_BalanceP2C_PenaltyPeakEwma_StatusRange {
	if x != nil {
		return x.HttpStatusRanges
	}
	return nil
}

func (x *Backend_BalanceP2C_PenaltyPeakEwma) GetGrpcStatusCodes() []uint32 {
	if x != nil {
		return x.GrpcStatusCodes
	}
	return nil
}

type Backend_BalanceP2C_PenaltyPeakEwma_StatusRange struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Start         uint32                 `protobuf:"varint,1,opt,name=start,proto3" json:"start,omitempty"`
	End           uint32                 `protobuf:"varint,2,opt,name=end,proto3" json:"end,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *Backend_BalanceP2C_PenaltyPeakEwma_StatusRange) Reset() {
	*x = Backend_BalanceP2C_PenaltyPeakEwma_StatusRange{}
	mi := &file_outbound_proto_msgTypes[60]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Backend_BalanceP2C_PenaltyPeakEwma_StatusRange) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Backend_BalanceP2C_PenaltyPeakEwma_StatusRange) ProtoMessage() {}

func (x *Backend_BalanceP2C_PenaltyPeakEwma_StatusRange) ProtoReflect() protoreflect.Message {
	mi := &file_outbound_proto_msgTypes[60]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Backend_BalanceP2C_PenaltyPeakEwma_StatusRange.ProtoReflect.Descriptor instead.
func (*Backend_BalanceP2C_PenaltyPeakEwma_StatusRange) Descriptor() ([]byte, []int) {
	return file_outbound_proto_rawDescGZIP(), []int{7, 1, 1, 0}
}

func (x *Backend_BalanceP2C_PenaltyPeakEwma_StatusRange) GetStart() uint32 {
	if x != nil {
		return x.Start
	}
	return 0
...
func (x *Backend_BalanceP2C_PenaltyPeakEwma_StatusRange) GetEnd() uint32 {
	if x != nil {
		return x.End
	}
	return 0
...
type Backend_BalanceP2C_PenaltyPeakEwma_RetryAfter struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The maximum duration to respect for Retry-After hints. Hints that exceed this value will be capped.
	MaxRetryAfter *duration.Duration `protobuf:"bytes,1,opt,name=max_retry_after,json=maxRetryAfter,proto3" json:"max_retry_after,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *Backend_BalanceP2C_PenaltyPeakEwma_RetryAfter) Reset() {
	*x = Backend_BalanceP2C_PenaltyPeakEwma_RetryAfter{}
	mi := &file_outbound_proto_msgTypes[61]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Backend_BalanceP2C_PenaltyPeakEwma_RetryAfter) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Backend_BalanceP2C_PenaltyPeakEwma_RetryAfter) ProtoMessage() {}

func (x *Backend_BalanceP2C_PenaltyPeakEwma_RetryAfter) ProtoReflect() protoreflect.Message {
	mi := &file_outbound_proto_msgTypes[61]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Backend_BalanceP2C_PenaltyPeakEwma_RetryAfter.ProtoReflect.Descriptor instead.
func (*Backend_BalanceP2C_PenaltyPeakEwma_RetryAfter) Descriptor() ([]byte, []int) {
	return file_outbound_proto_rawDescGZIP(), []int{7, 1, 1, 1}
}

func (x *Backend_BalanceP2C_PenaltyPeakEwma_RetryAfter) GetMaxRetryAfter() *duration.Duration {
	if x != nil {
		return x.MaxRetryAfter
	}
	return nil
}
...
type FailureAccrual_Unified struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *FailureAccrual_Unified) Reset() {
	*x = FailureAccrual_Unified{}
	mi := &file_outbound_proto_msgTypes[63]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *FailureAccrual_Unified) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FailureAccrual_Unified) ProtoMessage() {}

func (x *FailureAccrual_Unified) ProtoReflect() protoreflect.Message {
	mi := &file_outbound_proto_msgTypes[63]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FailureAccrual_Unified.ProtoReflect.Descriptor instead.
func (*FailureAccrual_Unified) Descriptor() ([]byte, []int) {
	return file_outbound_proto_rawDescGZIP(), []int{9, 1}
}

func (x *FailureAccrual_Unified) GetSuccessRateThreshold() float64 {
	if x != nil {
...
func (x *FailureAccrual_Unified) GetDecay() *duration.Duration {
	if x != nil {
		return x.Decay
	}
	return nil
...
func (x *FailureAccrual_Unified) GetMinRequests() uint32 {
	if x != nil {
...
func (x *FailureAccrual_Unified) GetMaxConsecutiveFailures() uint32 {
	if x != nil {
...
func (x *FailureAccrual_Unified) GetBackoff() *ExponentialBackoff {
	if x != nil {
		return x.Backoff
	}
	return nil
...
const file_outbound_proto_rawDesc = "" +
	...
	"\x06weight\x18\x02 \x01(\rR\x06weightJ\x04\b\x04\x10\x05\"\x87\f\n" +
	"\aBackend\x12;\n" +
	...
	"defaultRtt\x12/\n" +
	"\x05decay\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\x05decay\x1a\xa4\x05\n" +
	"\x0fPenaltyPeakEwma\x12:\n" +
	"\vdefault_rtt\x18\x01 \x01(\v2\x19.google.protobuf.DurationR\n" +
	"defaultRtt\x12/\n" +
	"\x05decay\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\x05decay\x123\n" +
	"\apenalty\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\apenalty\x12\x81\x01\n" +
	"\x18respect_retry_after_hint\x18\x04 \x01(\v2H.io.linkerd.proxy.outbound.Backend.BalanceP2c.PenaltyPeakEwma.RetryAfterR\x15respectRetryAfterHint\x12>\n" +
	"\rpenalty_decay\x18\x05 \x01(\v2\x19.google.protobuf.DurationR\fpenaltyDecay\x12w\n" +
	"\x12http_status_ranges\x18\x06 \x03(\v2I.io.linkerd.proxy.outbound.Backend.BalanceP2c.PenaltyPeakEwma.StatusRangeR\x10httpStatusRanges\x12*\n" +
	"\x11grpc_status_codes\x18\a \x03(\rR\x0fgrpcStatusCodes\x1a5\n" +
	"\vStatusRange\x12\x14\n" +
	"\x05start\x18\x01 \x01(\rR\x05start\x12\x10\n" +
	"\x03end\x18\x02 \x01(\rR\x03end\x1aO\n" +
	"\n" +
	"RetryAfter\x12A\n" +
	"\x0fmax_retry_after\x18\x01 \x01(\v2\x19.google.protobuf.DurationR\rmaxRetryAfterB\x06\n" +
	"\x04loadB\x06\n" +
	"\x04kind\"i\n" +
	"\x05Queue\x12\x1a\n" +
	...
	"\aUnified\x124\n" +
	"\x16success_rate_threshold\x18\x01 \x01(\x01R\x14successRateThreshold\x12/\n" +
	"\x05decay\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\x05decay\x12!\n" +
	"\fmin_requests\x18\x03 \x01(\rR\vminRequests\x128\n" +
	"\x18max_consecutive_failures\x18\x04 \x01(\rR\x16maxConsecutiveFailures\x12G\n" +
	"\abackoff\x18\x05 \x01(\v2-.io.linkerd.proxy.outbound.ExponentialBackoffR\abackoffB\x06\n" +
	"\x04kind\"@\n" +
	"\x0eEjectionConfig\x12.\n" +
	"\x13min_ready_endpoints\x18\x01 \x01(\rR\x11minReadyEndpoints\"\xe8\x01\n" +
	...
	"maxBackoff\x12!\n" +
	"\fjitter_ratio\x18\x03 \x01(\x02R\vjitterRatio\x127\n" +
	"\x18respect_retry_after_hint\x18\x04 \x01(\bR\x15respectRetryAfterHint2\xce\x01\n" +
...
var file_outbound_proto_msgTypes = make([]protoimpl.MessageInfo, 64)
var file_outbound_proto_goTypes = []any{
	...
	(*EjectionConfig)(nil),                                 // 10: io.linkerd.proxy.outbound.EjectionConfig
	(*ExponentialBackoff)(nil),                             // 11: io.linkerd.proxy.outbound.ExponentialBackoff
	(*ProxyProtocol_Detect)(nil),                           // 12: io.linkerd.proxy.outbound.ProxyProtocol.Detect
	(*ProxyProtocol_Opaque)(nil),                           // 13: io.linkerd.proxy.outbound.ProxyProtocol.Opaque
	(*ProxyProtocol_Http1)(nil),                            // 14: io.linkerd.proxy.outbound.ProxyProtocol.Http1
	(*ProxyProtocol_Http2)(nil),                            // 15: io.linkerd.proxy.outbound.ProxyProtocol.Http2
	(*ProxyProtocol_Grpc)(nil),                             // 16: io.linkerd.proxy.outbound.ProxyProtocol.Grpc
	(*ProxyProtocol_Tls)(nil),                              // 17: io.linkerd.proxy.outbound.ProxyProtocol.Tls
	(*HttpRoute_Rule)(nil),                                 // 18: io.linkerd.proxy.outbound.HttpRoute.Rule
	(*HttpRoute_Filter)(nil),                               // 19: io.linkerd.proxy.outbound.HttpRoute.Filter
	(*HttpRoute_Distribution)(nil),                         // 20: io.linkerd.proxy.outbound.HttpRoute.Distribution
	(*HttpRoute_Retry)(nil),                                // 21: io.linkerd.proxy.outbound.HttpRoute.Retry
	(*HttpRoute_RouteBackend)(nil),                         // 22: io.linkerd.proxy.outbound.HttpRoute.RouteBackend
	(*HttpRoute_WeightedRouteBackend)(nil),                 // 23: io.linkerd.proxy.outbound.HttpRoute.WeightedRouteBackend
	(*HttpRoute_Distribution_Empty)(nil),                   // 24: io.linkerd.proxy.outbound.HttpRoute.Distribution.Empty
	(*HttpRoute_Distribution_FirstAvailable)(nil),          // 25: io.linkerd.proxy.outbound.HttpRoute.Distribution.FirstAvailable
	(*HttpRoute_Distribution_RandomAvailable)(nil),         // 26: io.linkerd.proxy.outbound.HttpRoute.Distribution.RandomAvailable
	(*HttpRoute_Retry_Conditions)(nil),                     // 27: io.linkerd.proxy.outbound.HttpRoute.Retry.Conditions
	(*HttpRoute_Retry_Conditions_StatusRange)(nil),         // 28: io.linkerd.proxy.outbound.HttpRoute.Retry.Conditions.StatusRange
	(*GrpcRoute_Rule)(nil),                                 // 29: io.linkerd.proxy.outbound.GrpcRoute.Rule
	(*GrpcRoute_Filter)(nil),                               // 30: io.linkerd.proxy.outbound.GrpcRoute.Filter
	(*GrpcRoute_Distribution)(nil),                         // 31: io.linkerd.proxy.outbound.GrpcRoute.Distribution
	(*GrpcRoute_Retry)(nil),                                // 32: io.linkerd.proxy.outbound.GrpcRoute.Retry
	(*GrpcRoute_RouteBackend)(nil),                         // 33: io.linkerd.proxy.outbound.GrpcRoute.RouteBackend
	(*GrpcRoute_WeightedRouteBackend)(nil),                 // 34: io.linkerd.proxy.outbound.GrpcRoute.WeightedRouteBackend
	(*GrpcRoute_Distribution_Empty)(nil),                   // 35: io.linkerd.proxy.outbound.GrpcRoute.Distribution.Empty
	(*GrpcRoute_Distribution_FirstAvailable)(nil),          // 36: io.linkerd.proxy.outbound.GrpcRoute.Distribution.FirstAvailable
	(*GrpcRoute_Distribution_RandomAvailable)(nil),         // 37: io.linkerd.proxy.outbound.GrpcRoute.Distribution.RandomAvailable
	(*GrpcRoute_Retry_Conditions)(nil),                     // 38: io.linkerd.proxy.outbound.GrpcRoute.Retry.Conditions
	(*OpaqueRoute_Rule)(nil),                               // 39: io.linkerd.proxy.outbound.OpaqueRoute.Rule
	(*OpaqueRoute_Filter)(nil),                             // 40: io.linkerd.proxy.outbound.OpaqueRoute.Filter
	...
	(*TlsRoute_Filter)(nil),                                // 48: io.linkerd.proxy.outbound.TlsRoute.Filter
	...
	(*Backend_EndpointDiscovery)(nil),                      // 55: io.linkerd.proxy.outbound.Backend.EndpointDiscovery
	(*Backend_BalanceP2C)(nil),                             // 56: io.linkerd.proxy.outbound.Backend.BalanceP2c
	(*Backend_EndpointDiscovery_DestinationGet)(nil),       // 57: io.linkerd.proxy.outbound.Backend.EndpointDiscovery.DestinationGet
	(*Backend_BalanceP2C_PeakEwma)(nil),                    // 58: io.linkerd.proxy.outbound.Backend.BalanceP2c.PeakEwma
	(*Backend_BalanceP2C_PenaltyPeakEwma)(nil),             // 59: io.linkerd.proxy.outbound.Backend.BalanceP2c.PenaltyPeakEwma
	(*Backend_BalanceP2C_PenaltyPeakEwma_StatusRange)(nil), // 60: io.linkerd.proxy.outbound.Backend.BalanceP2c.PenaltyPeakEwma.StatusRange
	(*Backend_BalanceP2C_PenaltyPeakEwma_RetryAfter)(nil),  // 61: io.linkerd.proxy.outbound.Backend.BalanceP2c.PenaltyPeakEwma.RetryAfter
	(*FailureAccrual_ConsecutiveFailures)(nil),             // 62: io.linkerd.proxy.outbound.FailureAccrual.ConsecutiveFailures
	(*FailureAccrual_Unified)(nil),                         // 63: io.linkerd.proxy.outbound.FailureAccrual.Unified
	(*net.TcpAddress)(nil),                                 // 64: io.linkerd.proxy.net.TcpAddress
	(*meta.Metadata)(nil),                                  // 65: io.linkerd.proxy.meta.Metadata
	(*http_route.HostMatch)(nil),                           // 66: io.linkerd.proxy.http_route.HostMatch
	(*tls_route.SniMatch)(nil),                             // 67: io.linkerd.proxy.tls_route.SniMatch
	(*destination.WeightedAddr)(nil),                       // 68: io.linkerd.proxy.destination.WeightedAddr
	(*duration.Duration)(nil),                              // 69: google.protobuf.Duration
	(*http_route.HttpRouteMatch)(nil),                      // 70: io.linkerd.proxy.http_route.HttpRouteMatch
	(*http_route.Timeouts)(nil),                            // 71: io.linkerd.proxy.http_route.Timeouts
	(*http_route.HttpFailureInjector)(nil),                 // 72: io.linkerd.proxy.http_route.HttpFailureInjector
	(*http_route.RequestHeaderModifier)(nil),               // 73: io.linkerd.proxy.http_route.RequestHeaderModifier
	(*http_route.RequestRedirect)(nil),                     // 74: io.linkerd.proxy.http_route.RequestRedirect
	(*http_route.ResponseHeaderModifier)(nil),              // 75: io.linkerd.proxy.http_route.ResponseHeaderModifier
	(*grpc_route.GrpcRouteMatch)(nil),                      // 76: io.linkerd.proxy.grpc_route.GrpcRouteMatch
	(*grpc_route.GrpcFailureInjector)(nil),                 // 77: io.linkerd.proxy.grpc_route.GrpcFailureInjector
	(*opaque_route.Invalid)(nil),                           // 78: io.linkerd.proxy.opaque_route.Invalid
	(*opaque_route.Forbidden)(nil),                         // 79: io.linkerd.proxy.opaque_route.Forbidden
}
var file_outbound_proto_depIdxs = []int32{
	64,  // 0: io.linkerd.proxy.outbound.TrafficSpec.addr:type_name -> io.linkerd.proxy.net.TcpAddress
	2,   // 1: io.linkerd.proxy.outbound.OutboundPolicy.protocol:type_name -> io.linkerd.proxy.outbound.ProxyProtocol
	65,  // 2: io.linkerd.proxy.outbound.OutboundPolicy.metadata:type_name -> io.linkerd.proxy.meta.Metadata
	12,  // 3: io.linkerd.proxy.outbound.ProxyProtocol.detect:type_name -> io.linkerd.proxy.outbound.ProxyProtocol.Detect
	13,  // 4: io.linkerd.proxy.outbound.ProxyProtocol.opaque:type_name -> io.linkerd.proxy.outbound.ProxyProtocol.Opaque
	14,  // 5: io.linkerd.proxy.outbound.ProxyProtocol.http1:type_name -> io.linkerd.proxy.outbound.ProxyProtocol.Http1
	15,  // 6: io.linkerd.proxy.outbound.ProxyProtocol.http2:type_name -> io.linkerd.proxy.outbound.ProxyProtocol.Http2
	16,  // 7: io.linkerd.proxy.outbound.ProxyProtocol.grpc:type_name -> io.linkerd.proxy.outbound.ProxyProtocol.Grpc
	17,  // 8: io.linkerd.proxy.outbound.ProxyProtocol.tls:type_name -> io.linkerd.proxy.outbound.ProxyProtocol.Tls
	65,  // 9: io.linkerd.proxy.outbound.HttpRoute.metadata:type_name -> io.linkerd.proxy.meta.Metadata
	66,  // 10: io.linkerd.proxy.outbound.HttpRoute.hosts:type_name -> io.linkerd.proxy.http_route.HostMatch
	18,  // 11: io.linkerd.proxy.outbound.HttpRoute.rules:type_name -> io.linkerd.proxy.outbound.HttpRoute.Rule
	65,  // 12: io.linkerd.proxy.outbound.GrpcRoute.metadata:type_name -> io.linkerd.proxy.meta.Metadata
	66,  // 13: io.linkerd.proxy.outbound.GrpcRoute.hosts:type_name -> io.linkerd.proxy.http_route.HostMatch
	29,  // 14: io.linkerd.proxy.outbound.GrpcRoute.rules:type_name -> io.linkerd.proxy.outbound.GrpcRoute.Rule
	65,  // 15: io.linkerd.proxy.outbound.OpaqueRoute.metadata:type_name -> io.linkerd.proxy.meta.Metadata
	39,  // 16: io.linkerd.proxy.outbound.OpaqueRoute.rules:type_name -> io.linkerd.proxy.outbound.OpaqueRoute.Rule
	65,  // 17: io.linkerd.proxy.outbound.TlsRoute.metadata:type_name -> io.linkerd.proxy.meta.Metadata
	67,  // 18: io.linkerd.proxy.outbound.TlsRoute.snis:type_name -> io.linkerd.proxy.tls_route.SniMatch
	47,  // 19: io.linkerd.proxy.outbound.TlsRoute.rules:type_name -> io.linkerd.proxy.outbound.TlsRoute.Rule
	65,  // 20: io.linkerd.proxy.outbound.Backend.metadata:type_name -> io.linkerd.proxy.meta.Metadata
	68,  // 21: io.linkerd.proxy.outbound.Backend.forward:type_name -> io.linkerd.proxy.destination.WeightedAddr
	56,  // 22: io.linkerd.proxy.outbound.Backend.balancer:type_name -> io.linkerd.proxy.outbound.Backend.BalanceP2c
	8,   // 23: io.linkerd.proxy.outbound.Backend.queue:type_name -> io.linkerd.proxy.outbound.Queue
	69,  // 24: io.linkerd.proxy.outbound.Queue.failfast_timeout:type_name -> google.protobuf.Duration
	62,  // 25: io.linkerd.proxy.outbound.FailureAccrual.consecutive_failures:type_name -> io.linkerd.proxy.outbound.FailureAccrual.ConsecutiveFailures
	63,  // 26: io.linkerd.proxy.outbound.FailureAccrual.unified:type_name -> io.linkerd.proxy.outbound.FailureAccrual.Unified
	10,  // 27: io.linkerd.proxy.outbound.FailureAccrual.ejection:type_name -> io.linkerd.proxy.outbound.EjectionConfig
	69,  // 28: io.linkerd.proxy.outbound.ExponentialBackoff.min_backoff:type_name -> google.protobuf.Duration
	69,  // 29: io.linkerd.proxy.outbound.ExponentialBackoff.max_backoff:type_name -> google.protobuf.Duration
	69,  // 30: io.linkerd.proxy.outbound.ProxyProtocol.Detect.timeout:type_name -> google.protobuf.Duration
	...
	70,  // 42: io.linkerd.proxy.outbound.HttpRoute.Rule.matches:type_name -> io.linkerd.proxy.http_route.HttpRouteMatch
	...
	69,  // 45: io.linkerd.proxy.outbound.HttpRoute.Rule.requestTimeout:type_name -> google.protobuf.Duration
	71,  // 46: io.linkerd.proxy.outbound.HttpRoute.Rule.timeouts:type_name -> io.linkerd.proxy.http_route.Timeouts
	21,  // 47: io.linkerd.proxy.outbound.HttpRoute.Rule.retry:type_name -> io.linkerd.proxy.outbound.HttpRoute.Retry
	72,  // 48: io.linkerd.proxy.outbound.HttpRoute.Filter.failure_injector:type_name -> io.linkerd.proxy.http_route.HttpFailureInjector
	73,  // 49: io.linkerd.proxy.outbound.HttpRoute.Filter.request_header_modifier:type_name -> io.linkerd.proxy.http_route.RequestHeaderModifier
	74,  // 50: io.linkerd.proxy.outbound.HttpRoute.Filter.redirect:type_name -> io.linkerd.proxy.http_route.RequestRedirect
	75,  // 51: io.linkerd.proxy.outbound.HttpRoute.Filter.response_header_modifier:type_name -> io.linkerd.proxy.http_route.ResponseHeaderModifier
	...
	69,  // 56: io.linkerd.proxy.outbound.HttpRoute.Retry.timeout:type_name -> google.protobuf.Duration
	...
	69,  // 60: io.linkerd.proxy.outbound.HttpRoute.RouteBackend.requestTimeout:type_name -> google.protobuf.Duration
	...
	76,  // 65: io.linkerd.proxy.outbound.GrpcRoute.Rule.matches:type_name -> io.linkerd.proxy.grpc_route.GrpcRouteMatch
	...
	69,  // 68: io.linkerd.proxy.outbound.GrpcRoute.Rule.requestTimeout:type_name -> google.protobuf.Duration
	71,  // 69: io.linkerd.proxy.outbound.GrpcRoute.Rule.timeouts:type_name -> io.linkerd.proxy.http_route.Timeouts
	32,  // 70: io.linkerd.proxy.outbound.GrpcRoute.Rule.retry:type_name -> io.linkerd.proxy.outbound.GrpcRoute.Retry
	77,  // 71: io.linkerd.proxy.outbound.GrpcRoute.Filter.failure_injector:type_name -> io.linkerd.proxy.grpc_route.GrpcFailureInjector
	73,  // 72: io.linkerd.proxy.outbound.GrpcRoute.Filter.request_header_modifier:type_name -> io.linkerd.proxy.http_route.RequestHeaderModifier
	...
	69,  // 77: io.linkerd.proxy.outbound.GrpcRoute.Retry.timeout:type_name -> google.protobuf.Duration
	...
	69,  // 81: io.linkerd.proxy.outbound.GrpcRoute.RouteBackend.requestTimeout:type_name -> google.protobuf.Duration
	...
	78,  // 87: io.linkerd.proxy.outbound.OpaqueRoute.Filter.invalid:type_name -> io.linkerd.proxy.opaque_route.Invalid
	79,  // 88: io.linkerd.proxy.outbound.OpaqueRoute.Filter.forbidden:type_name -> io.linkerd.proxy.opaque_route.Forbidden
	...
	78,  // 99: io.linkerd.proxy.outbound.TlsRoute.Filter.invalid:type_name -> io.linkerd.proxy.opaque_route.Invalid
	79,  // 100: io.linkerd.proxy.outbound.TlsRoute.Filter.forbidden:type_name -> io.linkerd.proxy.opaque_route.Forbidden
	...
	69,  // 113: io.linkerd.proxy.outbound.Backend.BalanceP2c.PeakEwma.default_rtt:type_name -> google.protobuf.Duration
	69,  // 114: io.linkerd.proxy.outbound.Backend.BalanceP2c.PeakEwma.decay:type_name -> google.protobuf.Duration
	69,  // 115: io.linkerd.proxy.outbound.Backend.BalanceP2c.PenaltyPeakEwma.default_rtt:type_name -> google.protobuf.Duration
	69,  // 116: io.linkerd.proxy.outbound.Backend.BalanceP2c.PenaltyPeakEwma.decay:type_name -> google.protobuf.Duration
	69,  // 117: io.linkerd.proxy.outbound.Backend.BalanceP2c.PenaltyPeakEwma.penalty:type_name -> google.protobuf.Duration
	61,  // 118: io.linkerd.proxy.outbound.Backend.BalanceP2c.PenaltyPeakEwma.respect_retry_after_hint:type_name -> io.linkerd.proxy.outbound.Backend.BalanceP2c.PenaltyPeakEwma.RetryAfter
	69,  // 119: io.linkerd.proxy.outbound.Backend.BalanceP2c.PenaltyPeakEwma.penalty_decay:type_name -> google.protobuf.Duration
	60,  // 120: io.linkerd.proxy.outbound.Backend.BalanceP2c.PenaltyPeakEwma.http_status_ranges:type_name -> io.linkerd.proxy.outbound.Backend.BalanceP2c.PenaltyPeakEwma.StatusRange
	69,  // 121: io.linkerd.proxy.outbound.Backend.BalanceP2c.PenaltyPeakEwma.RetryAfter.max_retry_after:type_name -> google.protobuf.Duration
	11,  // 122: io.linkerd.proxy.outbound.FailureAccrual.ConsecutiveFailures.backoff:type_name -> io.linkerd.proxy.outbound.ExponentialBackoff
	69,  // 123: io.linkerd.proxy.outbound.FailureAccrual.Unified.decay:type_name -> google.protobuf.Duration
	11,  // 124: io.linkerd.proxy.outbound.FailureAccrual.Unified.backoff:type_name -> io.linkerd.proxy.outbound.ExponentialBackoff
...
func file_outbound_proto_init() {
	...
	file_outbound_proto_msgTypes[56].OneofWrappers = []any{
		...
		(*Backend_BalanceP2C_PenaltyPeakEwma_)(nil),
	}
	type x struct{}
