...
var file_outbound_proto_rawDesc = []byte{
	...
	0x42, 0x06, 0x0a, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x22, 0xd7, 0x02, 0x0a, 0x09, 0x48, 0x74, 0x74,
	...
	0x73, 0x12, 0x3f, 0x0a, 0x05, 0x72, 0x75, 0x6c, 0x65, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b,
	...
	0x65, 0x73, 0x1a, 0x8d, 0x01, 0x0a, 0x04, 0x52, 0x75, 0x6c, 0x65, 0x12, 0x45, 0x0a, 0x07, 0x6d,
...
var file_outbound_proto_goTypes = []interface{}{
	...
	(*destination.WeightedDst)(nil),   // 15: io.linkerd.proxy.destination.WeightedDst
	(*destination.WeightedAddr)(nil),  // 16: io.linkerd.proxy.destination.WeightedAddr
	(*duration.Duration)(nil),         // 17: google.protobuf.Duration
	(*http_route.HttpRouteMatch)(nil), // 18: io.linkerd.proxy.http_route.HttpRouteMatch
}
var file_outbound_proto_depIdxs = []int32{
	...
	15, // 12: io.linkerd.proxy.outbound.Backend.dst:type_name -> io.linkerd.proxy.destination.WeightedDst
	16, // 13: io.linkerd.proxy.outbound.Backend.endpoint:type_name -> io.linkerd.proxy.destination.WeightedAddr
	17, // 14: io.linkerd.proxy.outbound.ProxyProtocol.Detect.timeout:type_name -> google.protobuf.Duration
	3,  // 15: io.linkerd.proxy.outbound.ProxyProtocol.Detect.http_routes:type_name -> io.linkerd.proxy.outbound.HttpRoute
	3,  // 16: io.linkerd.proxy.outbound.ProxyProtocol.Http1.routes:type_name -> io.linkerd.proxy.outbound.HttpRoute
	3,  // 17: io.linkerd.proxy.outbound.ProxyProtocol.Http2.routes:type_name -> io.linkerd.proxy.outbound.HttpRoute
	18, // 18: io.linkerd.proxy.outbound.HttpRoute.Rule.matches:type_name -> io.linkerd.proxy.http_route.HttpRouteMatch
	4,  // 19: io.linkerd.proxy.outbound.HttpRoute.Rule.backends:type_name -> io.linkerd.proxy.outbound.Backend
	0,  // 20: io.linkerd.proxy.outbound.OutboundPolicies.Get:input_type -> io.linkerd.proxy.outbound.TargetSpec
	0,  // 21: io.linkerd.proxy.outbound.OutboundPolicies.Watch:input_type -> io.linkerd.proxy.outbound.TargetSpec
	1,  // 22: io.linkerd.proxy.outbound.OutboundPolicies.Get:output_type -> io.linkerd.proxy.outbound.Service
	1,  // 23: io.linkerd.proxy.outbound.OutboundPolicies.Watch:output_type -> io.linkerd.proxy.outbound.Service
