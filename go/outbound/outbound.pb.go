...
type FailureAccrual struct {
	...
	ConsecutiveFailures *FailureAccrual_ConsecutiveFailures `protobuf:"bytes,1,opt,name=consecutive_failures,json=consecutiveFailures,proto3" json:"consecutive_failures,omitempty"`
	// Success rate policy. If set, the circuit trips when the EWMA success
	// rate drops below the threshold.
	SuccessRate   *FailureAccrual_SuccessRate `protobuf:"bytes,2,opt,name=success_rate,json=successRate,proto3" json:"success_rate,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *FailureAccrual) GetSuccessRate() *FailureAccrual_SuccessRate {
	if x != nil {
...
type LoadBiasConfig struct {
	...
	Penalty *duration.Duration `protobuf:"bytes,2,opt,name=penalty,proto3" json:"penalty,omitempty"`
	// The EWMA decay window for the penalty.
	PenaltyDecay  *duration.Duration `protobuf:"bytes,3,opt,name=penalty_decay,json=penaltyDecay,proto3" json:"penalty_decay,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *LoadBiasConfig) Reset() {
	*x = LoadBiasConfig{}
...
func (x *LoadBiasConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LoadBiasConfig) ProtoMessage() {}

func (x *LoadBiasConfig) ProtoReflect() protoreflect.Message {
	mi := &file_outbound_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LoadBiasConfig.ProtoReflect.Descriptor instead.
func (*LoadBiasConfig) Descriptor() ([]byte, []int) {
	return file_outbound_proto_rawDescGZIP(), []int{10}
}

func (x *LoadBiasConfig) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
func (x *LoadBiasConfig) GetPenalty() *duration.Duration {
	if x != nil {
		return x.Penalty
	}
	return nil
...
func (x *LoadBiasConfig) GetPenaltyDecay() *duration.Duration {
	if x != nil {
		return x.PenaltyDecay
	}
	return nil
}
...
func (x *RetryAfterConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RetryAfterConfig) ProtoMessage() {}

func (x *RetryAfterConfig) ProtoReflect() protoreflect.Message {
	mi := &file_outbound_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RetryAfterConfig.ProtoReflect.Descriptor instead.
func (*RetryAfterConfig) Descriptor() ([]byte, []int) {
	return file_outbound_proto_rawDescGZIP(), []int{11}
}

func (x *RetryAfterConfig) GetMaxDuration() *duration.Duration {
	if x != nil {
...
type EjectionConfig struct {
	...
	MinReadyEndpoints uint32 `protobuf:"varint,1,opt,name=min_ready_endpoints,json=minReadyEndpoints,proto3" json:"min_ready_endpoints,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}

func (x *EjectionConfig) Reset() {
	*x = EjectionConfig{}
...
func (x *EjectionConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EjectionConfig) ProtoMessage() {}

func (x *EjectionConfig) ProtoReflect() protoreflect.Message {
	mi := &file_outbound_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EjectionConfig.ProtoReflect.Descriptor instead.
func (*EjectionConfig) Descriptor() ([]byte, []int) {
	return file_outbound_proto_rawDescGZIP(), []int{12}
}

func (x *EjectionConfig) GetMinReadyEndpoints() uint32 {
	if x != nil {
		return x.MinReadyEndpoints
	}
	return 0
}
...
type ProxyProtocol_Http1 struct {
	...
	LoadBias *LoadBiasConfig `protobuf:"bytes,3,opt,name=load_bias,json=loadBias,proto3" json:"load_bias,omitempty"`
	// If set, configures handling of Retry-After headers (HTTP 429/503).
	RetryAfter    *RetryAfterConfig `protobuf:"bytes,4,opt,name=retry_after,json=retryAfter,proto3" json:"retry_after,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ProxyProtocol_Http1) GetLoadBias() *LoadBiasConfig {
	if x != nil {
		return x.LoadBias
	}
	return nil
...
func (x *ProxyProtocol_Http1) GetRetryAfter() *RetryAfterConfig {
	if x != nil {
		return x.RetryAfter
	}
	return nil
...
func (x *ProxyProtocol_Http2) GetLoadBias() *LoadBiasConfig {
	if x != nil {
		return x.LoadBias
	}
	return nil
...
func (x *ProxyProtocol_Http2) GetRetryAfter() *RetryAfterConfig {
	if x != nil {
		return x.RetryAfter
	}
	return nil
...
func (x *ProxyProtocol_Grpc) GetLoadBias() *LoadBiasConfig {
	if x != nil {
		return x.LoadBias
	}
	return nil
...
func (x *ProxyProtocol_Grpc) GetRetryAfter() *RetryAfterConfig {
	if x != nil {
		return x.RetryAfter
	}
	return nil
...
func (x *FailureAccrual_ConsecutiveFailures) Reset() {
	*x = FailureAccrual_ConsecutiveFailures{}
	mi := &file_outbound_proto_msgTypes[61]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type FailureAccrual_SuccessRate struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	...
	MinRequests   uint32 `protobuf:"varint,3,opt,name=min_requests,json=minRequests,proto3" json:"min_requests,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *FailureAccrual_SuccessRate) Reset() {
	*x = FailureAccrual_SuccessRate{}
	mi := &file_outbound_proto_msgTypes[62]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *FailureAccrual_SuccessRate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FailureAccrual_SuccessRate) ProtoMessage() {}

func (x *FailureAccrual_SuccessRate) ProtoReflect() protoreflect.Message {
	mi := &file_outbound_proto_msgTypes[62]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FailureAccrual_SuccessRate.ProtoReflect.Descriptor instead.
func (*FailureAccrual_SuccessRate) Descriptor() ([]byte, []int) {
	return file_outbound_proto_rawDescGZIP(), []int{9, 1}
}

func (x *FailureAccrual_SuccessRate) GetThreshold() float64 {
	if x != nil {
		return x.Threshold
	}
	return 0
...
func (x *FailureAccrual_SuccessRate) GetDecay() *duration.Duration {
	if x != nil {
		return x.Decay
	}
	return nil
...
func (x *FailureAccrual_SuccessRate) GetMinRequests() uint32 {
	if x != nil {
...
var file_outbound_proto_msgTypes = make([]protoimpl.MessageInfo, 63)
var file_outbound_proto_goTypes = []any{
	...
	(*LoadBiasConfig)(nil),                           // 10: io.linkerd.proxy.outbound.LoadBiasConfig
	(*RetryAfterConfig)(nil),                         // 11: io.linkerd.proxy.outbound.RetryAfterConfig
	(*EjectionConfig)(nil),                           // 12: io.linkerd.proxy.outbound.EjectionConfig
	(*ExponentialBackoff)(nil),                       // 13: io.linkerd.proxy.outbound.ExponentialBackoff
	(*ProxyProtocol_Detect)(nil),                     // 14: io.linkerd.proxy.outbound.ProxyProtocol.Detect
	(*ProxyProtocol_Opaque)(nil),                     // 15: io.linkerd.proxy.outbound.ProxyProtocol.Opaque
	(*ProxyProtocol_Http1)(nil),                      // 16: io.linkerd.proxy.outbound.ProxyProtocol.Http1
	(*ProxyProtocol_Http2)(nil),                      // 17: io.linkerd.proxy.outbound.ProxyProtocol.Http2
	(*ProxyProtocol_Grpc)(nil),                       // 18: io.linkerd.proxy.outbound.ProxyProtocol.Grpc
	(*ProxyProtocol_Tls)(nil),                        // 19: io.linkerd.proxy.outbound.ProxyProtocol.Tls
	(*HttpRoute_Rule)(nil),                           // 20: io.linkerd.proxy.outbound.HttpRoute.Rule
	(*HttpRoute_Filter)(nil),                         // 21: io.linkerd.proxy.outbound.HttpRoute.Filter
	(*HttpRoute_Distribution)(nil),                   // 22: io.linkerd.proxy.outbound.HttpRoute.Distribution
	(*HttpRoute_Retry)(nil),                          // 23: io.linkerd.proxy.outbound.HttpRoute.Retry
	(*HttpRoute_RouteBackend)(nil),                   // 24: io.linkerd.proxy.outbound.HttpRoute.RouteBackend
	(*HttpRoute_WeightedRouteBackend)(nil),           // 25: io.linkerd.proxy.outbound.HttpRoute.WeightedRouteBackend
	(*HttpRoute_Distribution_Empty)(nil),             // 26: io.linkerd.proxy.outbound.HttpRoute.Distribution.Empty
	(*HttpRoute_Distribution_FirstAvailable)(nil),    // 27: io.linkerd.proxy.outbound.HttpRoute.Distribution.FirstAvailable
	(*HttpRoute_Distribution_RandomAvailable)(nil),   // 28: io.linkerd.proxy.outbound.HttpRoute.Distribution.RandomAvailable
	(*HttpRoute_Retry_Conditions)(nil),               // 29: io.linkerd.proxy.outbound.HttpRoute.Retry.Conditions
	(*HttpRoute_Retry_Conditions_StatusRange)(nil),   // 30: io.linkerd.proxy.outbound.HttpRoute.Retry.Conditions.StatusRange
	(*GrpcRoute_Rule)(nil),                           // 31: io.linkerd.proxy.outbound.GrpcRoute.Rule
	(*GrpcRoute_Filter)(nil),                         // 32: io.linkerd.proxy.outbound.GrpcRoute.Filter
	(*GrpcRoute_Distribution)(nil),                   // 33: io.linkerd.proxy.outbound.GrpcRoute.Distribution
	(*GrpcRoute_Retry)(nil),                          // 34: io.linkerd.proxy.outbound.GrpcRoute.Retry
	(*GrpcRoute_RouteBackend)(nil),                   // 35: io.linkerd.proxy.outbound.GrpcRoute.RouteBackend
	(*GrpcRoute_WeightedRouteBackend)(nil),           // 36: io.linkerd.proxy.outbound.GrpcRoute.WeightedRouteBackend
	(*GrpcRoute_Distribution_Empty)(nil),             // 37: io.linkerd.proxy.outbound.GrpcRoute.Distribution.Empty
	(*GrpcRoute_Distribution_FirstAvailable)(nil),    // 38: io.linkerd.proxy.outbound.GrpcRoute.Distribution.FirstAvailable
	(*GrpcRoute_Distribution_RandomAvailable)(nil),   // 39: io.linkerd.proxy.outbound.GrpcRoute.Distribution.RandomAvailable
	(*GrpcRoute_Retry_Conditions)(nil),               // 40: io.linkerd.proxy.outbound.GrpcRoute.Retry.Conditions
	(*OpaqueRoute_Rule)(nil),                         // 41: io.linkerd.proxy.outbound.OpaqueRoute.Rule
	(*OpaqueRoute_Filter)(nil),                       // 42: io.linkerd.proxy.outbound.OpaqueRoute.Filter
	(*OpaqueRoute_Distribution)(nil),                 // 43: io.linkerd.proxy.outbound.OpaqueRoute.Distribution
	(*OpaqueRoute_RouteBackend)(nil),                 // 44: io.linkerd.proxy.outbound.OpaqueRoute.RouteBackend
	(*OpaqueRoute_WeightedRouteBackend)(nil),         // 45: io.linkerd.proxy.outbound.OpaqueRoute.WeightedRouteBackend
	(*OpaqueRoute_Distribution_Empty)(nil),           // 46: io.linkerd.proxy.outbound.OpaqueRoute.Distribution.Empty
	(*OpaqueRoute_Distribution_FirstAvailable)(nil),  // 47: io.linkerd.proxy.outbound.OpaqueRoute.Distribution.FirstAvailable
	(*OpaqueRoute_Distribution_RandomAvailable)(nil), // 48: io.linkerd.proxy.outbound.OpaqueRoute.Distribution.RandomAvailable
	(*TlsRoute_Rule)(nil),                            // 49: io.linkerd.proxy.outbound.TlsRoute.Rule
	(*TlsRoute_Filter)(nil),                          // 50: io.linkerd.proxy.outbound.TlsRoute.Filter
	(*TlsRoute_Distribution)(nil),                    // 51: io.linkerd.proxy.outbound.TlsRoute.Distribution
	(*TlsRoute_RouteBackend)(nil),                    // 52: io.linkerd.proxy.outbound.TlsRoute.RouteBackend
	(*TlsRoute_WeightedRouteBackend)(nil),            // 53: io.linkerd.proxy.outbound.TlsRoute.WeightedRouteBackend
	...
	(*Backend_EndpointDiscovery)(nil),                // 57: io.linkerd.proxy.outbound.Backend.EndpointDiscovery
	(*Backend_BalanceP2C)(nil),                       // 58: io.linkerd.proxy.outbound.Backend.BalanceP2c
	(*Backend_EndpointDiscovery_DestinationGet)(nil), // 59: io.linkerd.proxy.outbound.Backend.EndpointDiscovery.DestinationGet
	(*Backend_BalanceP2C_PeakEwma)(nil),              // 60: io.linkerd.proxy.outbound.Backend.BalanceP2c.PeakEwma
	(*FailureAccrual_ConsecutiveFailures)(nil),       // 61: io.linkerd.proxy.outbound.FailureAccrual.ConsecutiveFailures
	(*FailureAccrual_SuccessRate)(nil),               // 62: io.linkerd.proxy.outbound.FailureAccrual.SuccessRate
	...
	(*opaque_route.Invalid)(nil),                     // 77: io.linkerd.proxy.opaque_route.Invalid
	(*opaque_route.Forbidden)(nil),                   // 78: io.linkerd.proxy.opaque_route.Forbidden
}
var file_outbound_proto_depIdxs = []int32{
	...
	14,  // 3: io.linkerd.proxy.outbound.ProxyProtocol.detect:type_name -> io.linkerd.proxy.outbound.ProxyProtocol.Detect
	15,  // 4: io.linkerd.proxy.outbound.ProxyProtocol.opaque:type_name -> io.linkerd.proxy.outbound.ProxyProtocol.Opaque
	16,  // 5: io.linkerd.proxy.outbound.ProxyProtocol.http1:type_name -> io.linkerd.proxy.outbound.ProxyProtocol.Http1
	17,  // 6: io.linkerd.proxy.outbound.ProxyProtocol.http2:type_name -> io.linkerd.proxy.outbound.ProxyProtocol.Http2
	18,  // 7: io.linkerd.proxy.outbound.ProxyProtocol.grpc:type_name -> io.linkerd.proxy.outbound.ProxyProtocol.Grpc
	19,  // 8: io.linkerd.proxy.outbound.ProxyProtocol.tls:type_name -> io.linkerd.proxy.outbound.ProxyProtocol.Tls
	...
	20,  // 11: io.linkerd.proxy.outbound.HttpRoute.rules:type_name -> io.linkerd.proxy.outbound.HttpRoute.Rule
	...
	31,  // 14: io.linkerd.proxy.outbound.GrpcRoute.rules:type_name -> io.linkerd.proxy.outbound.GrpcRoute.Rule
	64,  // 15: io.linkerd.proxy.outbound.OpaqueRoute.metadata:type_name -> io.linkerd.proxy.meta.Metadata
	41,  // 16: io.linkerd.proxy.outbound.OpaqueRoute.rules:type_name -> io.linkerd.proxy.outbound.OpaqueRoute.Rule
	64,  // 17: io.linkerd.proxy.outbound.TlsRoute.metadata:type_name -> io.linkerd.proxy.meta.Metadata
	66,  // 18: io.linkerd.proxy.outbound.TlsRoute.snis:type_name -> io.linkerd.proxy.tls_route.SniMatch
	49,  // 19: io.linkerd.proxy.outbound.TlsRoute.rules:type_name -> io.linkerd.proxy.outbound.TlsRoute.Rule
	64,  // 20: io.linkerd.proxy.outbound.Backend.metadata:type_name -> io.linkerd.proxy.meta.Metadata
	67,  // 21: io.linkerd.proxy.outbound.Backend.forward:type_name -> io.linkerd.proxy.destination.WeightedAddr
	58,  // 22: io.linkerd.proxy.outbound.Backend.balancer:type_name -> io.linkerd.proxy.outbound.Backend.BalanceP2c
	8,   // 23: io.linkerd.proxy.outbound.Backend.queue:type_name -> io.linkerd.proxy.outbound.Queue
	68,  // 24: io.linkerd.proxy.outbound.Queue.failfast_timeout:type_name -> google.protobuf.Duration
	61,  // 25: io.linkerd.proxy.outbound.FailureAccrual.consecutive_failures:type_name -> io.linkerd.proxy.outbound.FailureAccrual.ConsecutiveFailures
	62,  // 26: io.linkerd.proxy.outbound.FailureAccrual.success_rate:type_name -> io.linkerd.proxy.outbound.FailureAccrual.SuccessRate
	68,  // 27: io.linkerd.proxy.outbound.LoadBiasConfig.penalty:type_name -> google.protobuf.Duration
	68,  // 28: io.linkerd.proxy.outbound.LoadBiasConfig.penalty_decay:type_name -> google.protobuf.Duration
	68,  // 29: io.linkerd.proxy.outbound.RetryAfterConfig.max_duration:type_name -> google.protobuf.Duration
	68,  // 30: io.linkerd.proxy.outbound.ExponentialBackoff.min_backoff:type_name -> google.protobuf.Duration
	68,  // 31: io.linkerd.proxy.outbound.ExponentialBackoff.max_backoff:type_name -> google.protobuf.Duration
	68,  // 32: io.linkerd.proxy.outbound.ProxyProtocol.Detect.timeout:type_name -> google.protobuf.Duration
	15,  // 33: io.linkerd.proxy.outbound.ProxyProtocol.Detect.opaque:type_name -> io.linkerd.proxy.outbound.ProxyProtocol.Opaque
	16,  // 34: io.linkerd.proxy.outbound.ProxyProtocol.Detect.http1:type_name -> io.linkerd.proxy.outbound.ProxyProtocol.Http1
	17,  // 35: io.linkerd.proxy.outbound.ProxyProtocol.Detect.http2:type_name -> io.linkerd.proxy.outbound.ProxyProtocol.Http2
	5,   // 36: io.linkerd.proxy.outbound.ProxyProtocol.Opaque.routes:type_name -> io.linkerd.proxy.outbound.OpaqueRoute
	3,   // 37: io.linkerd.proxy.outbound.ProxyProtocol.Http1.routes:type_name -> io.linkerd.proxy.outbound.HttpRoute
	9,   // 38: io.linkerd.proxy.outbound.ProxyProtocol.Http1.failure_accrual:type_name -> io.linkerd.proxy.outbound.FailureAccrual
	10,  // 39: io.linkerd.proxy.outbound.ProxyProtocol.Http1.load_bias:type_name -> io.linkerd.proxy.outbound.LoadBiasConfig
	11,  // 40: io.linkerd.proxy.outbound.ProxyProtocol.Http1.retry_after:type_name -> io.linkerd.proxy.outbound.RetryAfterConfig
	3,   // 41: io.linkerd.proxy.outbound.ProxyProtocol.Http2.routes:type_name -> io.linkerd.proxy.outbound.HttpRoute
	9,   // 42: io.linkerd.proxy.outbound.ProxyProtocol.Http2.failure_accrual:type_name -> io.linkerd.proxy.outbound.FailureAccrual
	10,  // 43: io.linkerd.proxy.outbound.ProxyProtocol.Http2.load_bias:type_name -> io.linkerd.proxy.outbound.LoadBiasConfig
	11,  // 44: io.linkerd.proxy.outbound.ProxyProtocol.Http2.retry_after:type_name -> io.linkerd.proxy.outbound.RetryAfterConfig
	4,   // 45: io.linkerd.proxy.outbound.ProxyProtocol.Grpc.routes:type_name -> io.linkerd.proxy.outbound.GrpcRoute
	9,   // 46: io.linkerd.proxy.outbound.ProxyProtocol.Grpc.failure_accrual:type_name -> io.linkerd.proxy.outbound.FailureAccrual
	10,  // 47: io.linkerd.proxy.outbound.ProxyProtocol.Grpc.load_bias:type_name -> io.linkerd.proxy.outbound.LoadBiasConfig
	11,  // 48: io.linkerd.proxy.outbound.ProxyProtocol.Grpc.retry_after:type_name -> io.linkerd.proxy.outbound.RetryAfterConfig
	6,   // 49: io.linkerd.proxy.outbound.ProxyProtocol.Tls.routes:type_name -> io.linkerd.proxy.outbound.TlsRoute
	69,  // 50: io.linkerd.proxy.outbound.HttpRoute.Rule.matches:type_name -> io.linkerd.proxy.http_route.HttpRouteMatch
	21,  // 51: io.linkerd.proxy.outbound.HttpRoute.Rule.filters:type_name -> io.linkerd.proxy.outbound.HttpRoute.Filter
	22,  // 52: io.linkerd.proxy.outbound.HttpRoute.Rule.backends:type_name -> io.linkerd.proxy.outbound.HttpRoute.Distribution
	68,  // 53: io.linkerd.proxy.outbound.HttpRoute.Rule.requestTimeout:type_name -> google.protobuf.Duration
	70,  // 54: io.linkerd.proxy.outbound.HttpRoute.Rule.timeouts:type_name -> io.linkerd.proxy.http_route.Timeouts
	23,  // 55: io.linkerd.proxy.outbound.HttpRoute.Rule.retry:type_name -> io.linkerd.proxy.outbound.HttpRoute.Retry
	71,  // 56: io.linkerd.proxy.outbound.HttpRoute.Filter.failure_injector:type_name -> io.linkerd.proxy.http_route.HttpFailureInjector
	72,  // 57: io.linkerd.proxy.outbound.HttpRoute.Filter.request_header_modifier:type_name -> io.linkerd.proxy.http_route.RequestHeaderModifier
	73,  // 58: io.linkerd.proxy.outbound.HttpRoute.Filter.redirect:type_name -> io.linkerd.proxy.http_route.RequestRedirect
	74,  // 59: io.linkerd.proxy.outbound.HttpRoute.Filter.response_header_modifier:type_name -> io.linkerd.proxy.http_route.ResponseHeaderModifier
	26,  // 60: io.linkerd.proxy.outbound.HttpRoute.Distribution.empty:type_name -> io.linkerd.proxy.outbound.HttpRoute.Distribution.Empty
	27,  // 61: io.linkerd.proxy.outbound.HttpRoute.Distribution.first_available:type_name -> io.linkerd.proxy.outbound.HttpRoute.Distribution.FirstAvailable
	28,  // 62: io.linkerd.proxy.outbound.HttpRoute.Distribution.random_available:type_name -> io.linkerd.proxy.outbound.HttpRoute.Distribution.RandomAvailable
	29,  // 63: io.linkerd.proxy.outbound.HttpRoute.Retry.conditions:type_name -> io.linkerd.proxy.outbound.HttpRoute.Retry.Conditions
	68,  // 64: io.linkerd.proxy.outbound.HttpRoute.Retry.timeout:type_name -> google.protobuf.Duration
	13,  // 65: io.linkerd.proxy.outbound.HttpRoute.Retry.backoff:type_name -> io.linkerd.proxy.outbound.ExponentialBackoff
	7,   // 66: io.linkerd.proxy.outbound.HttpRoute.RouteBackend.backend:type_name -> io.linkerd.proxy.outbound.Backend
	21,  // 67: io.linkerd.proxy.outbound.HttpRoute.RouteBackend.filters:type_name -> io.linkerd.proxy.outbound.HttpRoute.Filter
	68,  // 68: io.linkerd.proxy.outbound.HttpRoute.RouteBackend.requestTimeout:type_name -> google.protobuf.Duration
	24,  // 69: io.linkerd.proxy.outbound.HttpRoute.WeightedRouteBackend.backend:type_name -> io.linkerd.proxy.outbound.HttpRoute.RouteBackend
	24,  // 70: io.linkerd.proxy.outbound.HttpRoute.Distribution.FirstAvailable.backends:type_name -> io.linkerd.proxy.outbound.HttpRoute.RouteBackend
	25,  // 71: io.linkerd.proxy.outbound.HttpRoute.Distribution.RandomAvailable.backends:type_name -> io.linkerd.proxy.outbound.HttpRoute.WeightedRouteBackend
	30,  // 72: io.linkerd.proxy.outbound.HttpRoute.Retry.Conditions.status_ranges:type_name -> io.linkerd.proxy.outbound.HttpRoute.Retry.Conditions.StatusRange
	75,  // 73: io.linkerd.proxy.outbound.GrpcRoute.Rule.matches:type_name -> io.linkerd.proxy.grpc_route.GrpcRouteMatch
	32,  // 74: io.linkerd.proxy.outbound.GrpcRoute.Rule.filters:type_name -> io.linkerd.proxy.outbound.GrpcRoute.Filter
	33,  // 75: io.linkerd.proxy.outbound.GrpcRoute.Rule.backends:type_name -> io.linkerd.proxy.outbound.GrpcRoute.Distribution
	68,  // 76: io.linkerd.proxy.outbound.GrpcRoute.Rule.requestTimeout:type_name -> google.protobuf.Duration
	70,  // 77: io.linkerd.proxy.outbound.GrpcRoute.Rule.timeouts:type_name -> io.linkerd.proxy.http_route.Timeouts
	34,  // 78: io.linkerd.proxy.outbound.GrpcRoute.Rule.retry:type_name -> io.linkerd.proxy.outbound.GrpcRoute.Retry
	76,  // 79: io.linkerd.proxy.outbound.GrpcRoute.Filter.failure_injector:type_name -> io.linkerd.proxy.grpc_route.GrpcFailureInjector
	72,  // 80: io.linkerd.proxy.outbound.GrpcRoute.Filter.request_header_modifier:type_name -> io.linkerd.proxy.http_route.RequestHeaderModifier
	37,  // 81: io.linkerd.proxy.outbound.GrpcRoute.Distribution.empty:type_name -> io.linkerd.proxy.outbound.GrpcRoute.Distribution.Empty
	38,  // 82: io.linkerd.proxy.outbound.GrpcRoute.Distribution.first_available:type_name -> io.linkerd.proxy.outbound.GrpcRoute.Distribution.FirstAvailable
	39,  // 83: io.linkerd.proxy.outbound.GrpcRoute.Distribution.random_available:type_name -> io.linkerd.proxy.outbound.GrpcRoute.Distribution.RandomAvailable
	40,  // 84: io.linkerd.proxy.outbound.GrpcRoute.Retry.conditions:type_name -> io.linkerd.proxy.outbound.GrpcRoute.Retry.Conditions
	68,  // 85: io.linkerd.proxy.outbound.GrpcRoute.Retry.timeout:type_name -> google.protobuf.Duration
	13,  // 86: io.linkerd.proxy.outbound.GrpcRoute.Retry.backoff:type_name -> io.linkerd.proxy.outbound.ExponentialBackoff
	7,   // 87: io.linkerd.proxy.outbound.GrpcRoute.RouteBackend.backend:type_name -> io.linkerd.proxy.outbound.Backend
	32,  // 88: io.linkerd.proxy.outbound.GrpcRoute.RouteBackend.filters:type_name -> io.linkerd.proxy.outbound.GrpcRoute.Filter
	68,  // 89: io.linkerd.proxy.outbound.GrpcRoute.RouteBackend.requestTimeout:type_name -> google.protobuf.Duration
	35,  // 90: io.linkerd.proxy.outbound.GrpcRoute.WeightedRouteBackend.backend:type_name -> io.linkerd.proxy.outbound.GrpcRoute.RouteBackend
	35,  // 91: io.linkerd.proxy.outbound.GrpcRoute.Distribution.FirstAvailable.backends:type_name -> io.linkerd.proxy.outbound.GrpcRoute.RouteBackend
	36,  // 92: io.linkerd.proxy.outbound.GrpcRoute.Distribution.RandomAvailable.backends:type_name -> io.linkerd.proxy.outbound.GrpcRoute.WeightedRouteBackend
	43,  // 93: io.linkerd.proxy.outbound.OpaqueRoute.Rule.backends:type_name -> io.linkerd.proxy.outbound.OpaqueRoute.Distribution
	42,  // 94: io.linkerd.proxy.outbound.OpaqueRoute.Rule.filters:type_name -> io.linkerd.proxy.outbound.OpaqueRoute.Filter
	77,  // 95: io.linkerd.proxy.outbound.OpaqueRoute.Filter.invalid:type_name -> io.linkerd.proxy.opaque_route.Invalid
	78,  // 96: io.linkerd.proxy.outbound.OpaqueRoute.Filter.forbidden:type_name -> io.linkerd.proxy.opaque_route.Forbidden
	46,  // 97: io.linkerd.proxy.outbound.OpaqueRoute.Distribution.empty:type_name -> io.linkerd.proxy.outbound.OpaqueRoute.Distribution.Empty
	47,  // 98: io.linkerd.proxy.outbound.OpaqueRoute.Distribution.first_available:type_name -> io.linkerd.proxy.outbound.OpaqueRoute.Distribution.FirstAvailable
	48,  // 99: io.linkerd.proxy.outbound.OpaqueRoute.Distribution.random_available:type_name -> io.linkerd.proxy.outbound.OpaqueRoute.Distribution.RandomAvailable
	7,   // 100: io.linkerd.proxy.outbound.OpaqueRoute.RouteBackend.backend:type_name -> io.linkerd.proxy.outbound.Backend
	42,  // 101: io.linkerd.proxy.outbound.OpaqueRoute.RouteBackend.filters:type_name -> io.linkerd.proxy.outbound.OpaqueRoute.Filter
	44,  // 102: io.linkerd.proxy.outbound.OpaqueRoute.WeightedRouteBackend.backend:type_name -> io.linkerd.proxy.outbound.OpaqueRoute.RouteBackend
	44,  // 103: io.linkerd.proxy.outbound.OpaqueRoute.Distribution.FirstAvailable.backends:type_name -> io.linkerd.proxy.outbound.OpaqueRoute.RouteBackend
	45,  // 104: io.linkerd.proxy.outbound.OpaqueRoute.Distribution.RandomAvailable.backends:type_name -> io.linkerd.proxy.outbound.OpaqueRoute.WeightedRouteBackend
	51,  // 105: io.linkerd.proxy.outbound.TlsRoute.Rule.backends:type_name -> io.linkerd.proxy.outbound.TlsRoute.Distribution
	50,  // 106: io.linkerd.proxy.outbound.TlsRoute.Rule.filters:type_name -> io.linkerd.proxy.outbound.TlsRoute.Filter
	77,  // 107: io.linkerd.proxy.outbound.TlsRoute.Filter.invalid:type_name -> io.linkerd.proxy.opaque_route.Invalid
	78,  // 108: io.linkerd.proxy.outbound.TlsRoute.Filter.forbidden:type_name -> io.linkerd.proxy.opaque_route.Forbidden
	54,  // 109: io.linkerd.proxy.outbound.TlsRoute.Distribution.empty:type_name -> io.linkerd.proxy.outbound.TlsRoute.Distribution.Empty
	55,  // 110: io.linkerd.proxy.outbound.TlsRoute.Distribution.first_available:type_name -> io.linkerd.proxy.outbound.TlsRoute.Distribution.FirstAvailable
	56,  // 111: io.linkerd.proxy.outbound.TlsRoute.Distribution.random_available:type_name -> io.linkerd.proxy.outbound.TlsRoute.Distribution.RandomAvailable
	7,   // 112: io.linkerd.proxy.outbound.TlsRoute.RouteBackend.backend:type_name -> io.linkerd.proxy.outbound.Backend
	50,  // 113: io.linkerd.proxy.outbound.TlsRoute.RouteBackend.filters:type_name -> io.linkerd.proxy.outbound.TlsRoute.Filter
	52,  // 114: io.linkerd.proxy.outbound.TlsRoute.WeightedRouteBackend.backend:type_name -> io.linkerd.proxy.outbound.TlsRoute.RouteBackend
	52,  // 115: io.linkerd.proxy.outbound.TlsRoute.Distribution.FirstAvailable.backends:type_name -> io.linkerd.proxy.outbound.TlsRoute.RouteBackend
	53,  // 116: io.linkerd.proxy.outbound.TlsRoute.Distribution.RandomAvailable.backends:type_name -> io.linkerd.proxy.outbound.TlsRoute.WeightedRouteBackend
	59,  // 117: io.linkerd.proxy.outbound.Backend.EndpointDiscovery.dst:type_name -> io.linkerd.proxy.outbound.Backend.EndpointDiscovery.DestinationGet
	57,  // 118: io.linkerd.proxy.outbound.Backend.BalanceP2c.discovery:type_name -> io.linkerd.proxy.outbound.Backend.EndpointDiscovery
	60,  // 119: io.linkerd.proxy.outbound.Backend.BalanceP2c.peak_ewma:type_name -> io.linkerd.proxy.outbound.Backend.BalanceP2c.PeakEwma
	12,  // 120: io.linkerd.proxy.outbound.Backend.BalanceP2c.ejection:type_name -> io.linkerd.proxy.outbound.EjectionConfig
	68,  // 121: io.linkerd.proxy.outbound.Backend.BalanceP2c.PeakEwma.default_rtt:type_name -> google.protobuf.Duration
	68,  // 122: io.linkerd.proxy.outbound.Backend.BalanceP2c.PeakEwma.decay:type_name -> google.protobuf.Duration
	13,  // 123: io.linkerd.proxy.outbound.FailureAccrual.ConsecutiveFailures.backoff:type_name -> io.linkerd.proxy.outbound.ExponentialBackoff
	68,  // 124: io.linkerd.proxy.outbound.FailureAccrual.SuccessRate.decay:type_name -> google.protobuf.Duration
	0,   // 125: io.linkerd.proxy.outbound.OutboundPolicies.Get:input_type -> io.linkerd.proxy.outbound.TrafficSpec
	0,   // 126: io.linkerd.proxy.outbound.OutboundPolicies.Watch:input_type -> io.linkerd.proxy.outbound.TrafficSpec
	1,   // 127: io.linkerd.proxy.outbound.OutboundPolicies.Get:output_type -> io.linkerd.proxy.outbound.OutboundPolicy
	1,   // 128: io.linkerd.proxy.outbound.OutboundPolicies.Watch:output_type -> io.linkerd.proxy.outbound.OutboundPolicy
...
func file_outbound_proto_init() {
	...
	file_outbound_proto_msgTypes[22].OneofWrappers = []any{
	...
	file_outbound_proto_msgTypes[50].OneofWrappers = []any{
		(*TlsRoute_Filter_Invalid)(nil),
		(*TlsRoute_Filter_Forbidden)(nil),
	}
	file_outbound_proto_msgTypes[51].OneofWrappers = []any{
	...
	file_outbound_proto_msgTypes[58].OneofWrappers = []any{
