...
var file_outbound_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0x82, 0x02, 0x0a, 0x07, 0x42, 0x72, 0x65, 0x61, 0x6b, 0x65,
	0x72, 0x12, 0x6b, 0x0a, 0x14, 0x63, 0x6f, 0x6e, 0x73, 0x65, 0x63, 0x75, 0x74, 0x69, 0x76, 0x65,
	...
	0x78, 0x79, 0x2e, 0x6f, 0x75, 0x74, 0x62, 0x6f, 0x75, 0x6e, 0x64, 0x2e, 0x42, 0x72, 0x65, 0x61,
	0x6b, 0x65, 0x72, 0x2e, 0x43, 0x6f, 0x6e, 0x73, 0x65, 0x63, 0x75, 0x74, 0x69, 0x76, 0x65, 0x46,
...
var file_outbound_proto_goTypes = []interface{}{
	...
	(*Breaker_ConsecutiveFailures)(nil),              // 42: io.linkerd.proxy.outbound.Breaker.ConsecutiveFailures
...
var file_outbound_proto_depIdxs = []int32{
	...
	42, // 20: io.linkerd.proxy.outbound.Breaker.consecutive_failures:type_name -> io.linkerd.proxy.outbound.Breaker.ConsecutiveFailures
	...
	9,  // 74: io.linkerd.proxy.outbound.Breaker.ConsecutiveFailures.backoff:type_name -> io.linkerd.proxy.outbound.ExponentialBackoff
