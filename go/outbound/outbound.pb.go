...
type Backend_BalanceP2C_PenaltyPeakEwma struct {
	...
	MaxRetryAfter *duration.Duration `protobuf:"bytes,4,opt,name=max_retry_after,json=maxRetryAfter,proto3" json:"max_retry_after,omitempty"`
...
func (x *Backend_BalanceP2C_PenaltyPeakEwma) GetMaxRetryAfter() *duration.Duration {
	if x != nil {
...
const file_outbound_proto_rawDesc = "" +
	...
	"defaultRtt\x12/\n" +
	"\x05decay\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\x05decay\x1a\xb6\x02\n" +
	"\x0fPenaltyPeakEwma\x12:\n" +
	"\vdefault_rtt\x18\x01 \x01(\v2\x19.google.protobuf.DurationR\n" +
	"defaultRtt\x12/\n" +
	"\x05decay\x18\x02 \x01(\v2\x19.google.protobuf.DurationR\x05decay\x123\n" +
	"\apenalty\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\apenalty\x12A\n" +
	"\x0fmax_retry_after\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\rmaxRetryAfter\x12>\n" +
	"\rpenalty_decay\x18\x05 \x01(\v2\x19.google.protobuf.DurationR\fpenaltyDecayB\x06\n" +
	"\x04loadB\x06\n" +
	"\x04kind\"i\n" +
	"\x05Queue\x12\x1a\n" +
...
var file_outbound_proto_goTypes = []any{
	...
	(*FailureAccrual_Unified)(nil),                   // 61: io.linkerd.proxy.outbound.FailureAccrual.Unified
...
var file_outbound_proto_depIdxs = []int32{
	...
	67,  // 116: io.linkerd.proxy.outbound.Backend.BalanceP2c.PenaltyPeakEwma.decay:type_name -> google.protobuf.Duration
	67,  // 117: io.linkerd.proxy.outbound.Backend.BalanceP2c.PenaltyPeakEwma.penalty:type_name -> google.protobuf.Duration
	67,  // 118: io.linkerd.proxy.outbound.Backend.BalanceP2c.PenaltyPeakEwma.max_retry_after:type_name -> google.protobuf.Duration
	67,  // 119: io.linkerd.proxy.outbound.Backend.BalanceP2c.PenaltyPeakEwma.penalty_decay:type_name -> google.protobuf.Duration
	11,  // 120: io.linkerd.proxy.outbound.FailureAccrual.ConsecutiveFailures.backoff:type_name -> io.linkerd.proxy.outbound.ExponentialBackoff
	67,  // 121: io.linkerd.proxy.outbound.FailureAccrual.Unified.decay:type_name -> google.protobuf.Duration
	11,  // 122: io.linkerd.proxy.outbound.FailureAccrual.Unified.backoff:type_name -> io.linkerd.proxy.outbound.ExponentialBackoff
	0,   // 123: io.linkerd.proxy.outbound.OutboundPolicies.Get:input_type -> io.linkerd.proxy.outbound.TrafficSpec
	0,   // 124: io.linkerd.proxy.outbound.OutboundPolicies.Watch:input_type -> io.linkerd.proxy.outbound.TrafficSpec
	1,   // 125: io.linkerd.proxy.outbound.OutboundPolicies.Get:output_type -> io.linkerd.proxy.outbound.OutboundPolicy
	1,   // 126: io.linkerd.proxy.outbound.OutboundPolicies.Watch:output_type -> io.linkerd.proxy.outbound.OutboundPolicy
