...
/*
Package http_types is a generated protocol buffer package.
...
type HttpMethod_Registered_ struct {
	Registered HttpMethod_Registered `protobuf:"varint,1,opt,name=registered,enum=io.linkerd.proxy.http_types.HttpMethod_Registered,oneof"`
}
...
type Scheme_Registered_ struct {
	Registered Scheme_Registered `protobuf:"varint,1,opt,name=registered,enum=io.linkerd.proxy.http_types.Scheme_Registered,oneof"`
}
...
func init() { proto.RegisterFile("http_types.proto", fileDescriptor0) }
