...
const file_http_types_proto_rawDesc = "" +
	"\n" +
	"\x10http_types.proto\x12\x1bio.linkerd.proxy.http_types\"\x80\x02\n" +
	"\n" +
	"HttpMethod\x12T\n" +
	"\n" +
	"registered\x18\x01 \x01(\x0e22.io.linkerd.proxy.http_types.HttpMethod.RegisteredH\x00R\n" +
	"registered\x12$\n" +
	...
	"\x06Scheme\x12P\n" +
	"\n" +
	"registered\x18\x01 \x01(\x0e2..io.linkerd.proxy.http_types.Scheme.RegisteredH\x00R\n" +
	"registered\x12$\n" +
	...
	"\x04type\"\x84\x01\n" +
	"\aHeaders\x12E\n" +
	"\aheaders\x18\x01 \x03(\v2+.io.linkerd.proxy.http_types.Headers.HeaderR\aheaders\x1a2\n" +
	"\x06Header\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05value\x18\x02 \x01(\fR\x05valueB5Z3github.com/linkerd/linkerd2-proxy-api/go/http_typesb\x06proto3"

var (
	file_http_types_proto_rawDescOnce sync.Once
	file_http_types_proto_rawDescData []byte
)

func file_http_types_proto_rawDescGZIP() []byte {
	file_http_types_proto_rawDescOnce.Do(func() {
		file_http_types_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_http_types_proto_rawDesc), len(file_http_types_proto_rawDesc)))
	})
...
func file_http_types_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_http_types_proto_rawDesc), len(file_http_types_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
