...
func (TapEvent_ProxyDirection) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_tap_ba85d314b39db450, []int{2, 0}
}
...
func (*ObserveRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_ba85d314b39db450, []int{0}
}
...
func (m *ObserveRequest) GetExtract() *ObserveRequest_Extract {
	if m != nil {
		return m.Extract
	}
	return nil
...
func (*ObserveRequest_Match) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_ba85d314b39db450, []int{0, 0}
}
...
func (*ObserveRequest_Match_Seq) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_ba85d314b39db450, []int{0, 0, 0}
}
...
func (*ObserveRequest_Match_Label) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_ba85d314b39db450, []int{0, 0, 1}
}
...
func (*ObserveRequest_Match_Tcp) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_ba85d314b39db450, []int{0, 0, 2}
}
...
func (*ObserveRequest_Match_Tcp_Netmask) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_ba85d314b39db450, []int{0, 0, 2, 0}
}
...
func (*ObserveRequest_Match_Tcp_PortRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_ba85d314b39db450, []int{0, 0, 2, 1}
}
...
func (*ObserveRequest_Match_Http) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_ba85d314b39db450, []int{0, 0, 3}
}
...
func (*ObserveRequest_Match_Http_StringMatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_ba85d314b39db450, []int{0, 0, 3, 0}
}
...
func (m *ObserveRequest_Extract) Reset()         { *m = ObserveRequest_Extract{} }
func (m *ObserveRequest_Extract) String() string { return proto.CompactTextString(m) }
func (*ObserveRequest_Extract) ProtoMessage()    {}
func (*ObserveRequest_Extract) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_ba85d314b39db450, []int{0, 1}
}
func (m *ObserveRequest_Extract) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ObserveRequest_Extract.Unmarshal(m, b)
}
func (m *ObserveRequest_Extract) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ObserveRequest_Extract.Marshal(b, m, deterministic)
}
func (dst *ObserveRequest_Extract) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ObserveRequest_Extract.Merge(dst, src)
}
func (m *ObserveRequest_Extract) XXX_Size() int {
	return xxx_messageInfo_ObserveRequest_Extract.Size(m)
}
func (m *ObserveRequest_Extract) XXX_DiscardUnknown() {
	xxx_messageInfo_ObserveRequest_Extract.DiscardUnknown(m)
}

var xxx_messageInfo_ObserveRequest_Extract proto.InternalMessageInfo
...
func (m *ObserveRequest_Extract) GetHttp() *ObserveRequest_Extract_Http {
	if x, ok := m.GetExtract().(*ObserveRequest_Extract_Http_); ok {
		return x.Http
	}
	return nil
}
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*ObserveRequest_Extract) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _ObserveRequest_Extract_OneofMarshaler, _ObserveRequest_Extract_OneofUnmarshaler, _ObserveRequest_Extract_OneofSizer, []interface{}{
		(*ObserveRequest_Extract_Http_)(nil),
	}
}

func _ObserveRequest_Extract_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*ObserveRequest_Extract)
	// extract
	switch x := m.Extract.(type) {
	case *ObserveRequest_Extract_Http_:
		b.EncodeVarint(1<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Http); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("ObserveRequest_Extract.Extract has unexpected type %T", x)
	}
	return nil
}

func _ObserveRequest_Extract_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*ObserveRequest_Extract)
	switch tag {
	case 1: // extract.http
		if wire != proto.WireBytes {
		...
		msg := new(ObserveRequest_Extract_Http)
		err := b.DecodeMessage(msg)
		m.Extract = &ObserveRequest_Extract_Http_{msg}
		return true, err
	default:
		return false, nil
	}
...
func _ObserveRequest_Extract_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*ObserveRequest_Extract)
	// extract
	switch x := m.Extract.(type) {
	case *ObserveRequest_Extract_Http_:
...
func (m *ObserveRequest_Extract_Http) Reset()         { *m = ObserveRequest_Extract_Http{} }
func (m *ObserveRequest_Extract_Http) String() string { return proto.CompactTextString(m) }
func (*ObserveRequest_Extract_Http) ProtoMessage()    {}
func (*ObserveRequest_Extract_Http) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_ba85d314b39db450, []int{0, 1, 0}
}
func (m *ObserveRequest_Extract_Http) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ObserveRequest_Extract_Http.Unmarshal(m, b)
}
func (m *ObserveRequest_Extract_Http) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ObserveRequest_Extract_Http.Marshal(b, m, deterministic)
}
func (dst *ObserveRequest_Extract_Http) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ObserveRequest_Extract_Http.Merge(dst, src)
}
func (m *ObserveRequest_Extract_Http) XXX_Size() int {
	return xxx_messageInfo_ObserveRequest_Extract_Http.Size(m)
}
func (m *ObserveRequest_Extract_Http) XXX_DiscardUnknown() {
	xxx_messageInfo_ObserveRequest_Extract_Http.DiscardUnknown(m)
}

var xxx_messageInfo_ObserveRequest_Extract_Http proto.InternalMessageInfo
...
func (m *ObserveRequest_Extract_Http) GetHeaders() *ObserveRequest_Extract_Http_Headers {
	if x, ok := m.GetExtract().(*ObserveRequest_Extract_Http_Headers_); ok {
		return x.Headers
	}
	return nil
}
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*ObserveRequest_Extract_Http) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _ObserveRequest_Extract_Http_OneofMarshaler, _ObserveRequest_Extract_Http_OneofUnmarshaler, _ObserveRequest_Extract_Http_OneofSizer, []interface{}{
		(*ObserveRequest_Extract_Http_Headers_)(nil),
	}
}

func _ObserveRequest_Extract_Http_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*ObserveRequest_Extract_Http)
	// extract
	switch x := m.Extract.(type) {
	case *ObserveRequest_Extract_Http_Headers_:
		b.EncodeVarint(1<<3 | proto.WireBytes)
	...
	case nil:
	default:
		return fmt.Errorf("ObserveRequest_Extract_Http.Extract has unexpected type %T", x)
	}
	return nil
}

func _ObserveRequest_Extract_Http_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*ObserveRequest_Extract_Http)
	switch tag {
	case 1: // extract.headers
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ObserveRequest_Extract_Http_Headers)
		err := b.DecodeMessage(msg)
		m.Extract = &ObserveRequest_Extract_Http_Headers_{msg}
		return true, err
	default:
		return false, nil
	}
...
func _ObserveRequest_Extract_Http_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*ObserveRequest_Extract_Http)
	// extract
	switch x := m.Extract.(type) {
	case *ObserveRequest_Extract_Http_Headers_:
...
func (m *ObserveRequest_Extract_Http_Headers) Reset()         { *m = ObserveRequest_Extract_Http_Headers{} }
func (m *ObserveRequest_Extract_Http_Headers) String() string { return proto.CompactTextString(m) }
func (*ObserveRequest_Extract_Http_Headers) ProtoMessage()    {}
func (*ObserveRequest_Extract_Http_Headers) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_ba85d314b39db450, []int{0, 1, 0, 0}
}
func (m *ObserveRequest_Extract_Http_Headers) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_ObserveRequest_Extract_Http_Headers.Unmarshal(m, b)
}
func (m *ObserveRequest_Extract_Http_Headers) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_ObserveRequest_Extract_Http_Headers.Marshal(b, m, deterministic)
}
func (dst *ObserveRequest_Extract_Http_Headers) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ObserveRequest_Extract_Http_Headers.Merge(dst, src)
}
func (m *ObserveRequest_Extract_Http_Headers) XXX_Size() int {
	return xxx_messageInfo_ObserveRequest_Extract_Http_Headers.Size(m)
}
func (m *ObserveRequest_Extract_Http_Headers) XXX_DiscardUnknown() {
	xxx_messageInfo_ObserveRequest_Extract_Http_Headers.DiscardUnknown(m)
}

var xxx_messageInfo_ObserveRequest_Extract_Http_Headers proto.InternalMessageInfo
...
func (*Eos) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_ba85d314b39db450, []int{1}
}
...
func (*TapEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_ba85d314b39db450, []int{2}
}
...
func (*TapEvent_RouteMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_ba85d314b39db450, []int{2, 1}
}
...
func (*TapEvent_Http) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_ba85d314b39db450, []int{2, 2}
}
...
func (*TapEvent_Http_StreamId) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_ba85d314b39db450, []int{2, 2, 0}
}
...
func (*TapEvent_Http_RequestInit) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_ba85d314b39db450, []int{2, 2, 1}
}
...
func (m *TapEvent_Http_RequestInit) GetHeaders() *http_types.Headers {
	if m != nil {
		return m.Headers
	}
	return nil
...
func (*TapEvent_Http_ResponseInit) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_ba85d314b39db450, []int{2, 2, 2}
}
...
func (m *TapEvent_Http_ResponseInit) GetHeaders() *http_types.Headers {
	if m != nil {
		return m.Headers
	}
	return nil
...
func (*TapEvent_Http_ResponseEnd) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_ba85d314b39db450, []int{2, 2, 3}
}
...
func (m *TapEvent_Http_ResponseEnd) GetTrailers() *http_types.Headers {
	if m != nil {
		return m.Trailers
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*ObserveRequest_Extract)(nil), "io.linkerd.proxy.tap.ObserveRequest.Extract")
	proto.RegisterType((*ObserveRequest_Extract_Http)(nil), "io.linkerd.proxy.tap.ObserveRequest.Extract.Http")
	proto.RegisterType((*ObserveRequest_Extract_Http_Headers)(nil), "io.linkerd.proxy.tap.ObserveRequest.Extract.Http.Headers")
...
func init() { proto.RegisterFile("tap.proto", fileDescriptor_tap_ba85d314b39db450) }

var fileDescriptor_tap_ba85d314b39db450 = []byte{
	...
	,
}
