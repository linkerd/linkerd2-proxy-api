...
func (TapEvent_ProxyDirection) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{2, 0} }
...
type ObserveRequest_Match_Http_Scheme struct {
	Scheme *io_linkerd_proxy_http_types.Scheme `protobuf:"bytes,1,opt,name=scheme,oneof"`
}
type ObserveRequest_Match_Http_Method struct {
	Method *io_linkerd_proxy_http_types.HttpMethod `protobuf:"bytes,3,opt,name=method,oneof"`
}
...
func (m *ObserveRequest_Match_Http) GetScheme() *io_linkerd_proxy_http_types.Scheme {
...
func (m *ObserveRequest_Match_Http) GetMethod() *io_linkerd_proxy_http_types.HttpMethod {
...
func _ObserveRequest_Match_Http_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 1: // match.scheme
		...
		msg := new(io_linkerd_proxy_http_types.Scheme)
		err := b.DecodeMessage(msg)
...
func (*Eos) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func (*TapEvent) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (*TapEvent_EndpointMeta) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2, 0} }
...
func (*TapEvent_Http) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2, 1} }
...
func (*TapEvent_Http_StreamId) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2, 1, 0} }
...
type TapEvent_Http_RequestInit struct {
	...
	Method    *io_linkerd_proxy_http_types.HttpMethod `protobuf:"bytes,2,opt,name=method" json:"method,omitempty"`
	Scheme    *io_linkerd_proxy_http_types.Scheme     `protobuf:"bytes,3,opt,name=scheme" json:"scheme,omitempty"`
...
func (*TapEvent_Http_RequestInit) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2, 1, 1} }
...
func (m *TapEvent_Http_RequestInit) GetMethod() *io_linkerd_proxy_http_types.HttpMethod {
	if m != nil {
		return m.Method
	}
	return nil
...
func (m *TapEvent_Http_RequestInit) GetScheme() *io_linkerd_proxy_http_types.Scheme {
	if m != nil {
		return m.Scheme
	}
	return nil
...
func (*TapEvent_Http_ResponseEnd) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2, 1, 3} }
