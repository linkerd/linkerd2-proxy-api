...
type ObserveTraceRequest struct {
	...
	// Encodes request-matching logic.
	Match         *ObserveRequest_Match `protobuf:"bytes,4,opt,name=match,proto3" json:"match,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ObserveTraceRequest) GetMatch() *ObserveRequest_Match {
	if x != nil {
		return x.Match
	}
	return nil
...
const file_tap_proto_rawDesc = "" +
	...
	"\x05match\x18\x04 \x01(\v2*.io.linkerd.proxy.tap.ObserveRequest.MatchR\x05matchB\x11\n" +
	"\x0f_sample_percentB\x19\n" +
	"\x17_max_samples_per_second\"\x16\n" +
