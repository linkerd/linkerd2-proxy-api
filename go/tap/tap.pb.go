...
func (TapEvent_ProxyDirection) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_tap_df405c6e0db46cc1, []int{2, 0}
}
...
func (*ObserveRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_df405c6e0db46cc1, []int{0}
}
...
func (m *ObserveRequest) GetRequestBody() bool {
	if m != nil {
...
func (m *ObserveRequest) GetResponseBody() bool {
	if m != nil {
...
func (*ObserveRequest_Match) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_df405c6e0db46cc1, []int{0, 0}
}
...
func (*ObserveRequest_Match_Seq) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_df405c6e0db46cc1, []int{0, 0, 0}
}
...
func (*ObserveRequest_Match_Label) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_df405c6e0db46cc1, []int{0, 0, 1}
}
...
func (*ObserveRequest_Match_Tcp) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_df405c6e0db46cc1, []int{0, 0, 2}
}
...
func (*ObserveRequest_Match_Tcp_Netmask) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_df405c6e0db46cc1, []int{0, 0, 2, 0}
}
...
func (*ObserveRequest_Match_Tcp_PortRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_df405c6e0db46cc1, []int{0, 0, 2, 1}
}
...
func (*ObserveRequest_Match_Http) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_df405c6e0db46cc1, []int{0, 0, 3}
}
...
func (*ObserveRequest_Match_Http_StringMatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_df405c6e0db46cc1, []int{0, 0, 3, 0}
}
...
func (*Eos) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_df405c6e0db46cc1, []int{1}
}
...
func (*TapEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_df405c6e0db46cc1, []int{2}
}
...
func (*TapEvent_RouteMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_df405c6e0db46cc1, []int{2, 1}
}
...
type TapEvent_Http struct {
	...
	//	*TapEvent_Http_RequestData_
	//	*TapEvent_Http_ResponseData_
...
func (*TapEvent_Http) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_df405c6e0db46cc1, []int{2, 2}
}
...
type TapEvent_Http_RequestData_ struct {
	RequestData *TapEvent_Http_RequestData `protobuf:"bytes,4,opt,name=request_data,json=requestData,proto3,oneof"`
}

type TapEvent_Http_ResponseData_ struct {
	ResponseData *TapEvent_Http_ResponseData `protobuf:"bytes,5,opt,name=response_data,json=responseData,proto3,oneof"`
}
...
func (*TapEvent_Http_RequestData_) isTapEvent_Http_Event() {}

func (*TapEvent_Http_ResponseData_) isTapEvent_Http_Event() {}
...
func (m *TapEvent_Http) GetRequestData() *TapEvent_Http_RequestData {
	if x, ok := m.GetEvent().(*TapEvent_Http_RequestData_); ok {
		return x.RequestData
	}
	return nil
}

func (m *TapEvent_Http) GetResponseData() *TapEvent_Http_ResponseData {
	if x, ok := m.GetEvent().(*TapEvent_Http_ResponseData_); ok {
...
func (*TapEvent_Http) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _TapEvent_Http_OneofMarshaler, _TapEvent_Http_OneofUnmarshaler, _TapEvent_Http_OneofSizer, []interface{}{
		...
		(*TapEvent_Http_RequestData_)(nil),
		(*TapEvent_Http_ResponseData_)(nil),
	}
}
...
func _TapEvent_Http_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *TapEvent_Http_RequestData_:
		b.EncodeVarint(4<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.RequestData); err != nil {
			return err
		}
	case *TapEvent_Http_ResponseData_:
		b.EncodeVarint(5<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.ResponseData); err != nil {
			return err
		}
	case nil:
	default:
...
func _TapEvent_Http_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 3: // event.response_end
		...
		return true, err
	case 4: // event.request_data
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(TapEvent_Http_RequestData)
		err := b.DecodeMessage(msg)
		m.Event = &TapEvent_Http_RequestData_{msg}
		return true, err
	case 5: // event.response_data
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(TapEvent_Http_ResponseData)
		err := b.DecodeMessage(msg)
		m.Event = &TapEvent_Http_ResponseData_{msg}
		return true, err
	default:
		return false, nil
	}
...
func (*TapEvent_Http_StreamId) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_df405c6e0db46cc1, []int{2, 2, 0}
}
...
func (*TapEvent_Http_RequestInit) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_df405c6e0db46cc1, []int{2, 2, 1}
}
...
func (*TapEvent_Http_ResponseInit) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_df405c6e0db46cc1, []int{2, 2, 2}
}
...
type TapEvent_Http_RequestData struct {
	Id                   *TapEvent_Http_StreamId `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Data                 []byte                  `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`
	Eos                  bool                    `protobuf:"varint,3,opt,name=eos,proto3" json:"eos,omitempty"`
	SinceRequestInit     *duration.Duration      `protobuf:"bytes,4,opt,name=since_request_init,json=sinceRequestInit,proto3" json:"since_request_init,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                `json:"-"`
	XXX_unrecognized     []byte                  `json:"-"`
	XXX_sizecache        int32                   `json:"-"`
}

func (m *TapEvent_Http_RequestData) Reset()         { *m = TapEvent_Http_RequestData{} }
func (m *TapEvent_Http_RequestData) String() string { return proto.CompactTextString(m) }
func (*TapEvent_Http_RequestData) ProtoMessage()    {}
func (*TapEvent_Http_RequestData) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_df405c6e0db46cc1, []int{2, 2, 3}
}
func (m *TapEvent_Http_RequestData) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_TapEvent_Http_RequestData.Unmarshal(m, b)
}
func (m *TapEvent_Http_RequestData) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_TapEvent_Http_RequestData.Marshal(b, m, deterministic)
}
func (dst *TapEvent_Http_RequestData) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TapEvent_Http_RequestData.Merge(dst, src)
}
func (m *TapEvent_Http_RequestData) XXX_Size() int {
	return xxx_messageInfo_TapEvent_Http_RequestData.Size(m)
}
func (m *TapEvent_Http_RequestData) XXX_DiscardUnknown() {
	xxx_messageInfo_TapEvent_Http_RequestData.DiscardUnknown(m)
}

var xxx_messageInfo_TapEvent_Http_RequestData proto.InternalMessageInfo

func (m *TapEvent_Http_RequestData) GetId() *TapEvent_Http_StreamId {
	if m != nil {
		return m.Id
	}
	return nil
...
func (m *TapEvent_Http_RequestData) GetData() []byte {
	if m != nil {
		return m.Data
	}
	return nil
...
func (m *TapEvent_Http_RequestData) GetEos() bool {
	if m != nil {
		return m.Eos
	}
	return false
...
func (m *TapEvent_Http_RequestData) GetSinceRequestInit() *duration.Duration {
	if m != nil {
		return m.SinceRequestInit
	}
	return nil
...
type TapEvent_Http_ResponseData struct {
	Id                   *TapEvent_Http_StreamId `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Data                 []byte                  `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`
	Eos                  bool                    `protobuf:"varint,3,opt,name=eos,proto3" json:"eos,omitempty"`
	SinceRequestInit     *duration.Duration      `protobuf:"bytes,4,opt,name=since_request_init,json=sinceRequestInit,proto3" json:"since_request_init,omitempty"`
	SinceResponseInit    *duration.Duration      `protobuf:"bytes,5,opt,name=since_response_init,json=sinceResponseInit,proto3" json:"since_response_init,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                `json:"-"`
	XXX_unrecognized     []byte                  `json:"-"`
	XXX_sizecache        int32                   `json:"-"`
}

func (m *TapEvent_Http_ResponseData) Reset()         { *m = TapEvent_Http_ResponseData{} }
func (m *TapEvent_Http_ResponseData) String() string { return proto.CompactTextString(m) }
func (*TapEvent_Http_ResponseData) ProtoMessage()    {}
func (*TapEvent_Http_ResponseData) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_df405c6e0db46cc1, []int{2, 2, 4}
}
func (m *TapEvent_Http_ResponseData) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_TapEvent_Http_ResponseData.Unmarshal(m, b)
}
func (m *TapEvent_Http_ResponseData) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_TapEvent_Http_ResponseData.Marshal(b, m, deterministic)
}
func (dst *TapEvent_Http_ResponseData) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TapEvent_Http_ResponseData.Merge(dst, src)
}
func (m *TapEvent_Http_ResponseData) XXX_Size() int {
	return xxx_messageInfo_TapEvent_Http_ResponseData.Size(m)
}
func (m *TapEvent_Http_ResponseData) XXX_DiscardUnknown() {
	xxx_messageInfo_TapEvent_Http_ResponseData.DiscardUnknown(m)
}

var xxx_messageInfo_TapEvent_Http_ResponseData proto.InternalMessageInfo

func (m *TapEvent_Http_ResponseData) GetId() *TapEvent_Http_StreamId {
	if m != nil {
		return m.Id
	}
	return nil
...
func (m *TapEvent_Http_ResponseData) GetData() []byte {
	if m != nil {
		return m.Data
	}
	return nil
...
func (m *TapEvent_Http_ResponseData) GetEos() bool {
	if m != nil {
		return m.Eos
	}
	return false
...
func (m *TapEvent_Http_ResponseData) GetSinceRequestInit() *duration.Duration {
	if m != nil {
		return m.SinceRequestInit
	}
	return nil
...
func (m *TapEvent_Http_ResponseData) GetSinceResponseInit() *duration.Duration {
	if m != nil {
...
func (*TapEvent_Http_ResponseEnd) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_df405c6e0db46cc1, []int{2, 2, 5}
}
...
func init() {
	...
	proto.RegisterType((*TapEvent_Http_RequestData)(nil), "io.linkerd.proxy.tap.TapEvent.Http.RequestData")
	proto.RegisterType((*TapEvent_Http_ResponseData)(nil), "io.linkerd.proxy.tap.TapEvent.Http.ResponseData")
...
func init() { proto.RegisterFile("tap.proto", fileDescriptor_tap_df405c6e0db46cc1) }

var fileDescriptor_tap_df405c6e0db46cc1 = []byte{
	...
	,
}
