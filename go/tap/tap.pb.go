...
type ObserveRequest_Match_Tcp_Netmask struct {
	Ip                   *net.IPAddress `protobuf:"bytes,1,opt,name=ip" json:"ip,omitempty"`
...
type TapEvent struct {
	Source          *net.TcpAddress         `protobuf:"bytes,1,opt,name=source" json:"source,omitempty"`
	SourceMeta      *TapEvent_EndpointMeta  `protobuf:"bytes,5,opt,name=source_meta,json=sourceMeta" json:"source_meta,omitempty"`
	Destination     *net.TcpAddress         `protobuf:"bytes,2,opt,name=destination" json:"destination,omitempty"`
