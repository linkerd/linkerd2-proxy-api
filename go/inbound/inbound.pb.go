...
func file_inbound_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_inbound_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_inbound_proto_msgTypes[18].Exporter = func(v any, i int) any {
	...
	file_inbound_proto_msgTypes[19].OneofWrappers = []any{
		(*Authn_PermitMeshTLS_Unauthenticated)(nil),
		(*Authn_PermitMeshTLS_Identities)(nil),
	}
	file_inbound_proto_msgTypes[22].OneofWrappers = []any{
