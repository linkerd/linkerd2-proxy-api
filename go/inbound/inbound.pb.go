...
func (x *HttpRoute_Rule_Filter) GetError() *http_route.ErrorResponder {
	if x, ok := x.GetKind().(*HttpRoute_Rule_Filter_Error); ok {
		return x.Error
	}
	return nil
}
...
type HttpRoute_Rule_Filter_Error struct {
	Error *http_route.ErrorResponder `protobuf:"bytes,3,opt,name=error,proto3,oneof"`
}
...
func (*HttpRoute_Rule_Filter_Error) isHttpRoute_Rule_Filter_Kind() {}
...
var file_inbound_proto_rawDesc = []byte{
	...
	0x05, 0x70, 0x61, 0x72, 0x74, 0x73, 0x22, 0xff, 0x05, 0x0a, 0x09, 0x48, 0x74, 0x74, 0x70, 0x52,
	...
	0xa6, 0x03, 0x0a, 0x04, 0x52, 0x75, 0x6c, 0x65, 0x12, 0x41, 0x0a, 0x07, 0x6d, 0x61, 0x74, 0x63,
	...
	0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x1a, 0x8f, 0x02, 0x0a, 0x06, 0x46, 0x69, 0x6c, 0x74, 0x65,
	...
	0x00, 0x52, 0x08, 0x72, 0x65, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x12, 0x43, 0x0a, 0x05, 0x65,
	0x72, 0x72, 0x6f, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x69, 0x6f, 0x2e,
	0x6c, 0x69, 0x6e, 0x6b, 0x65, 0x72, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x78, 0x79, 0x2e, 0x68, 0x74,
	0x74, 0x70, 0x5f, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x65,
...
var file_inbound_proto_goTypes = []interface{}{
	...
	(*http_route.ErrorResponder)(nil),        // 30: io.linkerd.proxy.http_route.ErrorResponder
}
var file_inbound_proto_depIdxs = []int32{
	...
	30, // 34: io.linkerd.proxy.inbound.HttpRoute.Rule.Filter.error:type_name -> io.linkerd.proxy.http_route.ErrorResponder
...
func file_inbound_proto_init() {
	...
	file_inbound_proto_msgTypes[22].OneofWrappers = []interface{}{
		...
		(*HttpRoute_Rule_Filter_Error)(nil),
	}
	type x struct{}
